...
FeatsList["al story awards"] = {
	...
	"blessing of valhalla: illithids (fr-dc-death)" : {
		...
		source : [["AL","FR-DC"]],
		description : "As Magic action once per 7 days, I can summon 2 specital mind flayers in 60 ft. These Berserkers are immune to Charmed & Frightened, disappear after 1 hr or at 0 HP, are Friendly & follow my commands.",
	...
	"blessing of valhalla: the friends you made along the way (sj-dc-dd-11)" : {
		...
		source : [["AL","SJ-DC"]],
		description : "The Monad has taken me on numerous adventures and the bonds I built across worlds will last a lifetime. No matter where I am, I can always count on my fellow passengers and friends from Wildspace to come to my aid. All I need to do is call. As Magic action once per 7 days, I can summon 2 warrior spirits in 60 ft. The Berserkers are immune to Charmed & Frightened, disappear after 1 hr or at 0 HP, are Friendly & follow my commands.",
	...
	"blessing of wound closure (sj-dc-mist-1)" : {
		name : "Blessing of Wound Closure (SJ-DC-MIST-1)",
		source : [["AL","SJ-DC"]],
		description : "With this blessing, I'm permanently marked with a faint ghostly handprint somewhere on my body. I can also treat any Death Saving throw under 10 as a pass and when I roll a Hit Die to regain HP, double the amount it restores.",
    ...
    "boon of quick casting (ps-dc-ceg-2)": {
		...
		source : [["AL","PS-DC"]],
        description: "I choose one of my spells of 1st through 3rd level that has a casting time of 1 action. That spell's casting time is now 1 bonus action for me. I also gain one small permanent snake transformation of my choosing on my body in a location of my choosing, such as a patch of scales, forked tongue, etc",
    ...
    "boon of skill proficiency: star power (ps-dc-ravengard)": {
		name : "Star Power (Boon of Skill Proficiency, PS-DC-RAVENGARD)",
		source : [["AL","PS-DC"]],
	...
	"charm of the comet: enchanted amulet (fr-dc-pandora-jwei-7)" : {
		...
		source : [["AL","FR-DC"]],
		description : "This amulet grants me a portion of the charm and beauty of Sune to draw attention to myself. As an action, I can force a visible creature within 60 ft to focus on me. For 1 minute, creatures other than me and the target are invisible to the target. The effect ends if any creature other than me damages the target or forces them to make a saving throw. Charm vanishes once used 3 times.",
	...
	"dreamwalker (ddal5-11)" : {
		...
		source : [["AL","S5"]],
		description : "My meditations have granted me the gift of foresight. Upon receiving this story award, I roll a d20 & record the number rolled. Once (before the roll), I can replace any atk roll, saving throw, or ability check made by me or a creature I can see with the number I rolled. Once I have used my die this way, remove the reward. I may regain this story award by spending another 25 DT.",
	...
	"flying snake (ddep7-1)" : {
		...
		source : [["AL","S7"]],
		description : "I've unmasked the merchant prince Ifan Talro'aas a criminal. The Emerald Enclave is sitting on the information, choosing to monitor the prince rather than show their hand. As a reward, they've given me a trained flying snake to serve as my messenger. Once per adventure, I can attach a message to the flying snake and send it to one of my allies. This works as an animal messenger spell, but the message can only be sent to people I know.",
	...
	"hall of mirth (ddal6-3)" : {
		...
		source : [["AL","S6"]],
		description : "I spent time in the Hall of Mirth learning about giantkind, ancient Ostoria, and the giant language. I chose to learn the giant language for 50 downtime days. (Optional) In addition, I chose to learn about Ostoria for another 50 downtime days, giving me advantage on any future checks regarding giants or Ostoria.",
	...
	"hall of omens (ddal6-3)(diviner)" : {	
		...
		source : [["AL","S6"]],
		description : "I spent time in the Hall of Omens learning about signs and portents. As a wizard of the school of divination, I spent 200 downtime days to gain 1 additional portent die.",
	...
	"hall of omens (ddal6-3)(non-diviner)" : {	
		name : "Hall of Omens (DDAL6-3)",
		source : [["AL","S6"]],
		description : "I spent time in the Hall of Omens learning about signs and portents. As I'm not a wizard of divination, I spent 50 downtime days to gain 3 Luck Points and may use them as the Lucky feat. Once the 3 Luck Points are spent they aren't regained.",
	...
	"lich slayer (ddep7-2)" : {
		...
		source : [["AL","S7"]],
		description : "I helped an alliance of heroes stop Szass Tam and Valindra Shadowmantle from destroying Port Nyanzaru and conquering Chult. My name spread throughout the necromantic orders, where I am feared forevermore. I have advantage on saving throws made to resist spells cast by necromancers and other undead creatures.",
	...
	"lord of the gorge (ddal0-11f)" : {
		...
		source : [["AL","S0"]],
		description : "I defeated & killed Xak'thar the Twin, the ravenous conjoined twin pit fiends of the Gorge of Slaughter. I ascended to its place as lord of that pit & for a year & a day, my reign was bloody & brutal — until some meddling adventurer defeated me! I am retired from AL play for 366 days & upon my return, I'm proficient in Infernal & have a lemure follower; this creature is fanatically devoted but entirely pitiful. Downtime days couldn't lessen the time spent in Nessus.",
	...
	"plague buster (ddep7-2)" : {
		...
		source : [["AL","S7"]],
		description : "I helped an alliance of heroes concoct an antidote for the zombie plague ravaging Chult. My exposure to the antidote has hardened my immune system against disease. I have advantage on saving throws made to resist disease.",
		descriptionFull : "You helped an alliance of heroes concoct an antidote for the zombie plague ravaging Chult. Your exposure to the antidote has hardened your immune system against disease. You have advantage on saving throws made to resist disease.",
	...
	"quasit's essence (ddal5-8)" : {	
		...
		source : [["AL","S5"]],
		description : "The quasit K'nap, long trapped in Durlag's Tower with the obese and foul nalfeshnee Schvalt, demonstrated a greater-than-average ability to perform autonomous actions. I have retained a bit of his fleeting essence, and chosen to bolster my own quasit familiar via a powerful ritual using a magic staff. This ritual grants me access to the Variant: Quasit Familiar. The destroyed staff counts against my MIL & can't be regained.",
	...
	"student of stone (ddal5-11)" : {	
		...
		source : [["AL","S5"]],
		description : "I have studied under the tutelage of Illsenstaad, a legendary stone giant loremaster and stone carver. I gain the benefit of the dwarven Stonecunning trait. If I already possess the Stonecunning trait, I triple my proficiency bonus instead of doubling it. In addition, I also gain proficiency in mason's tools and the Giant language if I'm not already proficient.",
    ...
    "szass tam's arcane essence (ddep0-1)": {
		...
		source : [["AL","S0"]],
        description: "I have wrested away part of Szass Tam's essence. Specifically, this spark of energy was originally wrested from the vile lich himself, and grants one additional 9th level spell slot, provided that I already have one.",
    ...
    "szass tam's planar essence (ddep0-1)": {
		...
		source : [["AL","S0"]],
        description: "I have wrested away part of Szass Tam's essence. Specifically, this spark of energy allowed the lich's simulacrum to navigate the planes – and while I'm not as proficient with this skill, I can retain a small bit of its power. Once per short rest, I can cast the plane shift spell (no spell slot or components required) as an action. I can target only myself, and travel to or from one of the Outer Planes listed in Appendix C of the PHB. This choice is permanent.",
    ...
    "thanks of ilmater - immortality": {
		...
		source : [["AL","S9"]],
        description: "I have worked the will of the gods of light to maintain the balance of the Blood War. Now that I am 20th lvl, I may select this boon. I stop aging. I'm immune to any effect that would age me, and I can't die from old age.",
    ...
    "thanks of ilmater - planar travel": {
		...
		source : [["AL","S9"]],
        description: "I have worked the will of the gods of light to maintain the balance of the Blood War. Now that I'm 20th lvl, I may select this boon. Once per short rest, I can cast the plane shift spell (no spell slot or components required) as an action. I can target only myself, and travel to or from Brightwater: the realm of Ilmater and Sune in the Seven Heavens of Celestia.",
...
MagicItemsList["al event award items"] = {
	...
	"buckler of folding (ddce)" : {
		...
		source : ["DDCE",2021],
		type : "shield",
		description : "This small paper square fits in a pocket & is covered with runes. When I hold it in my hand, I can utter a command word as a bonus action to make the square magically unfold & become a shield as hard as wood. It folds back up upon uttering the same command word.",
	...
	"cuddly spider (ddce)" : {
		...
		source : ["DDCE",2021],
		type : "trinket",
		description : "Use a command word as a bonus action & this fuzzy toy spider magically sticks to any surface I place it on. It can be removed by using a bonus action to touch it and utter the command word again.",
	...
	"flask of glowworms (ddce)" : {
		...
		source : ["DDCE", 2021],
		type : "trinket",
		description : "This flask contains several glowworms & when held, exudes color-changing illumination equivalent to a torch. The flask magically sustains the glowworms & I can use an action while holding it to set the color of the light for 10 minutes.",
	...
	"harengon spirit club (ln-1)" : {
		...
		source : ["AL:LN", 2021],
		type : "weapon (club)",
		description : "This knotted club houses the spirit of a harengon. While wielding it, my ears grow long like a hare's, granting me advantage on Wisdom (Perception) checks involving hearing. In addition, I can cast the jump spell once per dawn.",
	...
	"viridian monocle (ddce)" : {
		...
		source : ["DDCE",2021],
		type : "trinket",
		description : "When this ornate malachite monocle is worn, I can speak Sylvan.",
...
MagicItemsList["al new items"] = {
	...
	"fey hound collar (fm)" : {
		...
		source : ["AL:FM", 2020],
		rarity : "unique",
		description : "As an action, while wearing this (very) punk rock collar, I create a 15-ft-diameter sphere of green mist, centered on and moving with me. The sphere spreads around corners and its area is heavily obscured. It lasts for 10 minutes or until a wind of moderate or greater speed (at least 10 miles per hour) disperses it. The collar can't be used this way again until the next dawn.",
...
changeeval : function () {
 ...
 removeeval : function () {
	...
	"ioun stone - celebration (ddal-drw5)" : {
		...
		rarity : "common",
		attunement : true,
		description : "Attuning to this pale red stone takes 1 min. Magic action to make orbit at 1d3ft. Utilize to stow. While in orbit, a bonus action makes the stone: 1) pulse with colored light for 1 min, creating 10 ft dim light; 2) emit harmless effect like sparks, musical notes, smell for 1 min; 3) pause in direction of most powerful caster/magical effect in 30ft. If none, aims toward Szass Tam's palace. The stone only works in Thay.",
	...
	"nettle (ddep4)" : {
		...
		description : "This sentient +2 hand crossbow has seen better times. The wood is cracked & splintered & the string is heavily-frayed. A large, blue feather hangs from the handgrip alongside a couple green glass baubles. The crossbow warns me, granting a +2 bonus to Initiative unless Incapacitated. Sentience: Chaotic Neutral. Hearing & Darkvision to 120 ft. Speaks Common & Halfling. Personality: Greedy, impetuous, demands to be polished or shouts insults & denies bonuses.",
	...
	"oathbinder (ddhc-toa-15)" : {
		...
		description : "Handed down through generations of holy warriors, Oathbinder is a sentient +2 warhammer made from gold, jade, & finished wood. When I hit Fiends/Undead, it deals +2d6 Radiant. If left \u226425 HP, must pass a DC 15 Wis save or die. If pass, Frightened of me until my next turn ends. While holding Oathbinder, it sheds 20-ft bright light & 20-ft dim. I can also cast Beacon of Hope once per dawn. If I flee from extraplanar evil, it mocks my cowardice.",
		descriptionLong : "Handed down through generations of holy warriors, Oathbinder is a sentient +2 warhammer fashioned from gold, jade, and finished wood. When I hit a Fiend or Undead, they take an extra 2d6 Radiant. If they're left with under 26 HP, they must pass a DC 15 Wisdom save or die. On a pass, they're Frightened of me until my next turn ends. While held, Oathbinder sheds 20-ft radius bright light and 20-ft dim. I can also cast Beacon of Hope once per dawn. Imbued with the lifeforce of an ancient celestial, Oathbinder is the sworn enemy of fiends and other evil extraplanar creatures. It speaks only when it has something important to say, and can often be openly curt and matter-of-fact when doing so. If I flee from extraplanar evil, Oathbinder mocks my cowardice.",
	...
	"selûne's owl-eye glasses (fm)" : {
		...
		rarity : "unique",
		attunement : true,
		description : "While wearing these glasses, as an action once per dawn, I can instantaneously resummon a deceased, certed or Holiday Event vanity pet or mount (only ones that can be returned to life by the find familiar or find steed spells.) If I unattune, that doesn't kill my pet.",
	...
	"shar's veil (fm)" : {
		...
		source : ["AL:FM", 2020],
		rarity : "unique",
		description : "Once per long rest, while wearing this purple and black shadowy veil, it gives me the illusion of death and decay for 1 hr. Lying motionless, I appear to be dead. In motion, I appear to be undead, but my creature type isn't changed. To tell that I'm disguised, a creature can use its action to inspect my appearance and must succeed on a DC 13 Intelligence (Investigation) check.",
	...
	"tarot card set (ln)" : {
		...
		source : ["AL:LN", 2020],
		rarity : "unique",
		description : "Once per day, draw a card & roll 1d4 to find out what it produces. The item disappears at dawn & I may roll again to reveal my next fortune. 1: The Flower - touching this card to a patch of earth in 5 ft sprouts 1 flower of my choice. The flower is nonmagical & grows or withers like normal. 2: The Yummy Meal - my favorite meal, the equivalent of 1 ration. 3: The Tea Pot - a tiny pot of tea, equivalent to 1 healing potion. 4: The Witch - a stone & twisted wire pendant. As an action, it gives me adv. on CHA checks vs humanoids (<= CR1), for 1 hr.",
	...
	"tyr's blessing of command (ccc-bmg-23 phlan2-2)" : {	
		...
		rarity : "unique",
		attunement : true,
		description : "This blessing has been bestowed upon me by Tyr in recognition of my service to the city and citizens of Phlan in the face of great peril to my own wellbeing. My Charisma score increases by 2, up to a maximum of 20. This blessing may be refused. If accepted, it requires an attunement slot.",
		scores : [0, 0, 0, 0, 0, 2],
	},
	...
	"tyr's blessing of the mind (ccc-bmg-22 phlan2-1)" : {	
		...
		rarity : "unique",
		attunement : true,
		description : "This blessing has been bestowed upon me by Tyr in recognition of my service to the city and citizens of Phlan in the face of great peril to my own wellbeing. My Intelligence score increases by 2, up to a maximum of 20. This blessing may be refused. If accepted, it requires an attunement slot. This blessing is not tradeable, and if refused or unattuned, it cannot be regained.",
		scores : [0, 0, 0, 2, 0, 0],
	},
	...
	"woe (ddal-drw16)" : {
		...
		rarity : "unique",
		attunement : true,
		description : "This blade, formed from Father Llymic's urge to destroy, is made from a bizarre icy crystal that appears to bend & twist when viewed peripherally. I have a +3 bonus to atk & dmg rolls made with this magic longsword & when presented with the chance to act violently, Woe heightens my urge to do so. If I wield Woe while wearing Discord, I'm unharmed by temperatures as low as −60 degrees Fahrenheit. Until I remove Discord, I gain the flaw “Bright light enrages me.”",
		descriptionLong : "This blade, formed from Father Llymic's urge to destroy, is made from a bizarre, icy crystal that appears to bend and twist when viewed peripherally. When Woe's bearer is presented with an opportunity to act violently, Woe heightens its urge to do so. I have a +3 bonus to attack and damage rolls made with this magic weapon. If I wield Woe while wearing Discord, I'm unharmed by temperatures as low as −60 degrees Fahrenheit. Additionally, until I remove Discord, I gain the flaw “Bright light enrages me.”",
	...
	"wooden gecko earrings (ddhc-toa-8)" : {
		...
		rarity : "uncommon",
		magicItemTable : "A",
		description : "After wearing these wooden gecko earrings for at least 1 day, I become proficient in Strength (Athletics) checks to climb, as long as my hands and feet are bare and touching the surface. However, I have an insatiable urge to eat insects.",
