...
FeatsList["al special awards"] = {
	...
	"blessing of protection: brandobaras (fr-dc-mcg-inn1)" : {	
		name : "Brandobaras' Blessing of Protection (",
		source : [["AL","FR-DC-MCG-INN1"]],
		description : "This blessing was given by Brandobaras for assisting the Keeper of the Shadow Armory. I gain a +1 bonus to AC and saving throws. Attacking a direct agent of Brandobaris will negate the blessing permanently.",
		descriptionFull : "This blessing is given by Brandobaras for assisting the Keeper of the Shadow Armory. Attacking a direct agent of Brandobaris will negate the blessing permanently.\n   You gain a +1 bonus to AC and saving throws.",
		extraAC : [{name : "Blessing of Protection", mod : 1, magic : true, text : "I gain a +1 bonus to AC."}],
		addMod : [{ type : "save", field : "all", mod : 1, text : "I gain a +1 bonus to all my saving throws." }]
	},
