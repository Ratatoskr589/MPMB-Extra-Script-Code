...
MagicItemsList["al event award items"] = {
	...
	"armor of last defense (fm)" : {
		...
		extraAC : [{name : "Armor of Last Defense (Bloodied)", mod : 2, magic : true, text : "I gain a +2 AC bonus while Bloodied."}],
		chooseGear : {
			type : "armor",
