...
MagicItemsList["al staffs"] = {
	...
	"staff of adornment: ocharine (sj-dc-dd-7)" : {
		...
		source : [["AL","SJ-DC"]],
		rarity : "common",
		description : "This intricately-carved lightweight obsidian staff is the main tool in the Harmonization process, focusing heated & pressurized water to carve Azurite into Azure Crystals. The staff has captured a sequence of tones that are released when it hits something. If I put an object up to 1 pound over the tip, it floats 1 inch from the staff & remains there until removed or out of my possession. The staff can have 3 objects floating at a time. I can make them spin or turn in place.",
	...
	"staff of adornment (sj-dc-den-h5)" : {
		...
		source : [["AL","SJ-DC"]],
		rarity : "common",
		description : "This staff is made from polished driftwood. If I put an object up to 1 pound above the tip, it floats 1 inch from the staff & remains there until removed or out of my possession. The staff can have 3 objects floating at a time. When used in any way, it begins to loudly sing the haunting sahuagin song heard at the Reef of Living Memory when souls are ritually trapped in the coral. I can make the objects turn in place.",
	...
	"staff of adornment (sj-dc-igc-ecp-5)" : {
		...
		source : [["AL","SJ-DC"]],
		rarity : "common",
		description : "This wooden staff is carved with the words “PROPERTY OF THE HOUSE OF THE PATH AND THE WAY. PLEASE RETURN IF FOUND”. It also warns me, giving +2 Initiative unless Incapacitated. If I put an object up to 1 pound above the tip, it floats 1 inch from the staff & remains there until removed or out of my possession. The staff can have 3 objects floating at a time. I can make them turn in place.",
	...
	"staff of adornment: shakujo (sj-dc-mwg-1)" : {
		...
		source : [["AL","SJ-DC"]],
		rarity : "common",
		description : "The shakujō is a wooden staff with a decorative metal head. 2 loops form the base of the headpiece, each with 3 gilded iron rings attached. The rings jangle softly to warn of danger, giving +2 Initiative if not Incapacitated. If I put an object up to 1 pound above the tip, it floats 1 inch from the staff & remains there until removed or out of my possession. The staff can have 3 objects floating at a time. I can make them turn in place.",
	...
	"staff of adornment (wbw-dc-nj-cou-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This staff is made of web produced by Yarnspinner. It's Archfey quality! If I put an object up to 1 pound above the tip, it floats 1 inch from the staff & remains there until removed or out of my possession. The staff can have 3 objects floating at a time. I can make them spin or turn in place.",
	...
	"staff of birdcalls (fr-dc-tt-t201)" : {
		...
		source : [["AL","FR-DC"]],
		rarity : "common",
		description : "This is Don-Jon Raskin's hiking pole. As bonus action, it sheds 10-ft bright light & 10-ft more dim, or stops. The pole has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek.",
	...
	"staff of birdcalls (wbw-dc-bire-1)" : {
		...
		descriptionFull : "While in possession of the staff, you feel fortunate and optimistic about what the future holds. Butterflies, with wings of various patterns and colours encompassing the entire rainbow, flutter harmlessly around you.\n   This wooden staff is decorated with bird carvings. It has 10 charges. While holding it, you can take a Magic action to expend 1 charge from the staff and cause it to create one of the following sounds, which can be heard out to 120 feet: a finch's chirp, a raven's caw, a duck's quack, a chicken's cluck, a goose's honk, a loon's call, a turkey's gobble, a seagull's cry, an owl's hoot, or an eagle's shriek.\n   " + toUni("Regaining Charges") + ". The staff regains 1d6+4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff explodes in a harmless cloud of bird feathers and is lost forever.",
		weight : 4,
		limfeaname : "Staff of Birdcalls",
		usages : 10,
		recovery : "dawn",
	...
	"staff of birdcalls (wbw-dc-death)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This staff is decorated with bird carvings & while held, I'm unharmed by extreme temps past 0\u00B0F & 100\u00B0F. It has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek.",
		descriptionFull : "You are unharmed by temperatures of 0 degrees Fahrenheit or lower, and 100 degrees Fahrenheit or higher.\n   This wooden staff is decorated with bird carvings. It has 10 charges. While holding it, you can take a Magic action to expend 1 charge from the staff and cause it to create one of the following sounds, which can be heard out to 120 feet: a finch's chirp, a raven's caw, a duck's quack, a chicken's cluck, a goose's honk, a loon's call, a turkey's gobble, a seagull's cry, an owl's hoot, or an eagle's shriek.\n   " + toUni("Regaining Charges") + ". The staff regains 1d6+4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff explodes in a harmless cloud of bird feathers and is lost forever.",
		weight : 4,
		savetxt : { immune : ["temps past 0\u00B0F/100\u00B0F"] },
		limfeaname : "Staff of Birdcalls",
		usages : 10,
	...
	"staff of birdcalls (wbw-dc-fdc-3)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This staff is decorated with bird carvings & feathers attached on one end. It has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek.",
	...
	"staff of birdcalls (wbw-dc-hbk-1)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This staff is decorated with bird carvings & whenever it's struck, I hear a few beats of a taiko drum. It has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek.",
	...
	"staff of birdcalls (wbw-dc-robin-1-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This staff is decorated with bird carvings. I hear robins when in danger, giving +2 Initiative unless Incapacitated. It has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek.",
	...
	"staff of birdcalls (wbw-dc-rook-1-4)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "common",
		description : "This bamboo staff is intricately carved with wondrous birds. It has 10 charges, 1d6+4 regained at dawn, 5% chance it's destroyed when last charge used. As Magic action, I can use 1 charge to create a sound to 120 ft: a finch's chirp, raven's caw, duck's quack, chicken's cluck, goose's honk, loon's call, turkey's gobble, seagull's cry, owl's hoot, or eagle's shriek. Another Magic action to make my voice carry clearly for 600 ft until my next turn ends.",
	...
	"staff of defense: xuanwu jade shuttle (sj-dc-dd-9)" : {
		...
		descriptionLong : "The Xuanwu Jade Shuttle is the latest innovation in the Huangfu's personal defense range. This short-hafted jade quarterstaff has a curved S-shaped handle inlaid with golden whorls and Draconic glyphs, and a flat disc-shaped head adorned with a carved dragon turtle rampant. The staff warns its bearer of threats with a dragon turtle's roar, granting a +2 bonus to your Initiative rolls if you don't have the Incapacitated condition. While held, I gain a +1 to AC. It has 10 charges, regaining 1d6+4 expended charges at dawn. If I use the last charge, roll a d20. On a 1, it's destroyed. I can use its charges to cast Mage Armor (1 charge) or Shield (2 charges). The mage armor materializes as a shimmering coat of gold lamellar and the shield manifests as an octagonal barrier of overlapping rune-carved tortoise shells.",
		descriptionFull : "This slender, hollow staff is made of glass yet is as strong as oak. It weighs 3 pounds. While holding the staff, you have a +1 bonus to your Armor Class."+
		toUni("\n   Spells") + ". The staff has 10 charges. While holding it, you can expend the requisite number of charges to cast one of the following spells from the staff: mage armor (1 charge) or shield (2 charges)."+
		"\n   The staff regains 1d6+4 expended charges daily at dawn. If you expend the staff's last charge, roll a d20. On a 1, the staff shatters and is destroyed."+
	...
	"staff of healing (ccc-qcc2019-3)" : {
		...
		source : [["AL","CCC"]],
		rarity : "rare",
		description : "This ivory staff has a painted red carving of a coiled snake around its length and 10 charges, regaining 1d6+4 at dawn. Charges can cast Cure Wounds (1/lvl, max 4th), Lesser Restoration (2) & Mass Cure Wounds (5) using my spellcasting ability. If the last charge used, roll 1d20. On a 1, it vanishes.",
	...
	"staff of healing (ccc-wyc-2-1)" : {
		...
		source : [["AL","CCC"]],
		rarity : "rare",
		description : "This golden metal staff is prominently inscribed with the iconography of Amaunator, clearly identifying me as a follower of the Inquisition. It has 10 charges, 1d6+4 regained at dawn. Charges can cast Cure Wounds (1/lvl, max 4th), Lesser Restoration (2) & Mass Cure Wounds (5) using my spellcasting ability. If the last charge used, 5% chance it vanishes.",
	...
	"staff of healing (ddep4)" : {
		...
		source : [["AL","S4"]],
		rarity : "rare",
		description : "This smooth wood staff is pale & streaked with multicolored veins. It has a hollow glass sphere with an illusory symbol of my deity. Luminescent butterflies flit around the top & I feel fortunate & optimistic about the future. The staff has 10 charges, 1d6+4 regained at dawn. Charges can cast Cure Wounds (1/lvl, max 4), Lesser Restoration (2) & Mass Cure Wounds (5) using my spell ability. If the last charge used, 5% chance it vanishes.",
	...
	"staff of the magi (ddal7-17)" : { // contains contributions by Pengsloth
		...
		source : [["AL","S7"]],
		rarity : "legendary",
		description : "Hewn from the bedrock of Chult itself, this mighty stone staff offers tremendous magical power; all it asks is that I honor Ubtao in return. While held, I have adv on saves vs spells, +2 to spell atks & acts as +2 quarterstaff. It has 50 charges for spells (regain 4d6+2 at dawn). As reaction, I can absorb spell targeting only me, converting its lvl to charges. If the staff has over 50 charges or I use Magic action, it breaks. 50% I go to random plane or take 16\xD7charges Force. All others in 30-ft take 6\xD7charges (DC 17 Dex for half).",
	...
	"staff of power (ddal5-19)" : {
		...
		source : [["AL","S5"]],
		rarity : "very rare",
		description : "This great ashen +2 staff is etched with swirling air & clouds & resizes to fit my hand. I gain +2 on saves, AC & spell atks. It has 20 charges for spells, 2d8+4 regained at dawn. 5% chance becomes +2 staff if last charge used. 5% regains 1d8+2 charges. Magic action to break staff. I go to random plane or take 16\xD7charges Force (50%). All others in 30-ft take 4\xD7charges (DC 17 Dex for half).",
		descriptionLong : "This great ashen staff is etched with designs of swirling air and clouds. It resizes to fit the hand of any who carry it. While held, I gain a +2 bonus to saves, AC, and spell attacks. The staff has 20 charges, regaining 2d8+4 at dawn. If I use the last charge, roll a d20. On a 1, it converts to a +2 quarterstaff. On a 20, it regains 1d8+2 charges. Charges can be used to cast spells. As Magic action, I can break it for a 30-ft explosion. When I do, there's a 50% chance I teleport to a random plane. If not I take 16\xD7 the charges left in Force damage. All others in area take 4\xD7; DC 17 Dex save halves.",
	...
	"staff of power: tongkat nenek kebayan (wbw-dc-dmmc-1)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This gnarled +2 meranti staff is longer than a normal walking stick & ends in a knot that fits my palm. I get +2 on saves, AC & spell atks. It has 20 charges for spells, 2d8+4 regained at dawn 5% chance to become +2 staff if last charge used. 5% to regain 1d8+2 charges. Magic action to break staff for 30-ft explosion. 50% I go to random plane or take 16\xD7 charges Force. Others take 4\xD7 charges (DC 17 Dex to half).",
		descriptionLong : "This gnarled +2 meranti staff is slightly longer than a regular walking stick & ends in a knot that fits in the palm of my hand. While held, I gain a +2 bonus to saves, AC, and spell attacks. The staff has 20 charges, regaining 2d8+4 at dawn. If I use the last charge, roll a d20. On a 1, it converts to a +2 quarterstaff. On a 20, it regains 1d8+2 charges. Charges can be used to cast spells. As Magic action, I can break it for a 30-ft explosion. When I do, there's a 50% chance I teleport to a random plane. If not I take 16\xD7 the charges left in Force damage. All others in area take 4\xD7; DC 17 Dex save halves.",
	...
	"staff of power: oblivia (wbw-dc-php-orng-2)" : {
		...
		descriptionLong : "This +2 staff heightens my urge to act selfish and malevolent when given the opportunity. It was held by Fraz Urb'loo when he was causing chaos in the fey domain of Fidestia. The archmage Fa'rah trusts me to bear this ominous weapon as he doesn't want it near his domain. While held, I gain a +2 bonus to saves, AC, and spell attacks. The staff has 20 charges, regaining 2d8+4 at dawn. If I use the last charge, roll a d20. On a 1, it converts to a +2 quarterstaff. On a 20, it regains 1d8+2 charges. Charges can be used to cast spells. As Magic action, I can break it for a 30-ft explosion. When I do, there's a 50% chance I teleport to a random plane. If not I take 16\xD7 the charges left in Force damage. All others in area take 4\xD7; DC 17 Dex save halves.",
	...
	"staff of the python (ccc-bmg-moon7-1)" : {
		...
		descriptionLong : "This blackened crooked 6-foot staff was made from the branch of a Dark Treant that hummed with power. It oozes a black tar-like venom at twilight. As Magic action, I can throw it on the ground within 10 ft where it becomes a Giant Constrictor Snake. As a bonus action, I can revert the snake to a staff. On my turn I can mentally command the snake if within 60 ft & not Incapacitated, deciding what it does on its next turn or a more general command. It acts directly after me. If the snake is reduced to 0 HP, it reverts to a staff and is destroyed. Otherwise, the snake always starts out with full HP.",
	...
	"staff of the python: earth tender's branch (ccc-bmg-moon8-2)" : {
		...
		descriptionLong : "This gnarled staff is carved from the wood of a cypress tree and bears numerous small holes in the wood. As Magic action, I can throw it on the ground within 10 ft where it becomes a Giant Constrictor Snake. As a bonus action, I can revert the snake to a staff. On my turn I can mentally command the snake if within 60 ft & not Incapacitated, deciding what it does on its next turn or a more general command. It acts directly after me. If the snake is reduced to 0 HP, it reverts to a staff and is destroyed. Otherwise, the snake always starts out with full HP.",
	...
	"staff of the python: bulkawa's benevolence (ccc-gsp2-2)" : {
		...
		descriptionLong : "The body of this staff is made from a narra tree. The curved head is copper & shaped like a snake. The staff is a symbol of Bulkawa's kindness; with it I will never face life's challenges alone. As Magic action throw the staff on ground within 10 ft where it becomes a Giant Constrictor Snake. Bulkawa, the summoned snake, has copper scales, glowing blue eyes, & a black tattoo of a 5-leaf clover near its tail. As a bonus action, I can revert the snake to a staff. On my turn I can mentally command the snake if within 60 ft & not Incapacitated, deciding what it does on its next turn or a more general command. It acts directly after me. If the snake is reduced to 0 HP, it reverts to a staff & is destroyed. Otherwise, the snake always starts out with full HP.",
	...
	"staff of the python: blackztaff (fr-dc-waterdeep-kyz)" : {
		...
		descriptionLong : "The gilded inlay of a flying snake extends over the length of this handsome black staff. As Magic action, say “Ffanksss” & throw it on the ground within 10 ft where it becomes a Giant Constrictor Snake that's bright green with a scale pattern across its back that resembles wings. As a bonus action, I can revert the snake to its staff form. On my turn I can mentally command the snake if within 60 ft & not Incapacitated, deciding what it does on its next turn or a more general command. It acts directly after me. If the snake is reduced to 0 HP, it reverts to its staff form & is dead when activated again (unless raised at DM discretion). Otherwise, the snake always starts out with full HP. This staff can only be broken by the casting of an Awaken spell on its snake form.",
	...
	"staff of striking (ddal10-10)" : {
		...
		source : [["AL","S10"]],
		rarity : "very rare",
		description : "This +3 quarterstaff is made of a single piece of unmelting, dark green ice. A dark shape writhes within; its exact form can't be discerned. The staff has 10 charges, 1d6+4 regained at dawn. When it hits, I can use 1-3 charges for +1d6 Force per charge. 5% chance to become nonmagical if last charged used.",
	...
	"staff of striking: moon dance (sj-dc-pandora-jwei-1)" : {
		...
		descriptionLong : "The tip of this magic quarterstaff curves in an arc resembling a crescent moon. In times of darkness, I can use a bonus action to make a full moon appear in the crescent, shedding bright light in a 10-ft-radius and dim light for another 10-ft, or stop. The staff gives a +3 bonus to attack and damage rolls and has 10 charges. When it hits with a melee attack, I can use up to 3 charges. For each charge, the target takes +1d6 Force. When I spend a charge, the crescent glows before an illumination of moonlight bursts forth. The staff regains 1d6+4 charges at dawn. If I use the last charge, roll a d20. On a 1, the staff becomes nonmagical. When dancing a ritual dedicated to Selune with this staff, a piece of my memory plays out in the minds of the viewers.",
	...
	"staff of striking: orcus wand splinter (sj-dc-triden-mw3)" : {
		...
		source : [["AL","SJ-DC"]],
		rarity : "very rare",
		description : "This large splinter of bone broke off the Wand of Orcus during the clash on the Airship Carrier Medusa. It radiates overwhelming energy and clings to whoever touches it, allowing attunement in 1 min. The splinter is a +3 quarterstaff with 10 charges, 1d6+4 regained at dawn. When it hits, I can use 1-3 charges for +1d6 Force per charge. 5% chance to become nonmagical if last charged used.",
	...
	"staff of swarming insects (ddex3-3)" : {
		...
		source : [["AL","S3"]],
		rarity : "rare",
		description : "This staff is made of finely-polished white wood. It has 10 charges, 1d6+4 regained at dawn. Charges cast spells or 1 charge creates 30-ft radius of spiders with gossamer wings around me for 10 min; area is heavily obscured for all others. Dispersed by strong wind. 5% chance destroyed if last charge used.",
	...
	"staff of swarming insects: mildy's (wbw-dc-des-1-7)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This ebon branch from the Gulthias Tree leaks crimson sap. The staff is unholy, a legacy of its crafting, & evil plants view me favorably. Mildy can summon all such staves as an action if they're on the same plane. It has 10 charges, 1d6+4 regained at dawn. Charges cast spells or 1 charge creates 30-ft radius of flying insects around me for 10 min; area is heavily obscured for all others. Dispersed by strong wind. 5% chance destroyed if last charge used.",
	...
	"staff of swarming insects: scorpion staff (wbw-dc-dge-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "John Dodge gave this metal staff to Mei'Shell to help him learn to swim. It has an obsidian scorpion fastened to the top but floats in liquids & gives adv. on Str (Athletics) checks to swim. The staff has 10 charges, 1d6+4 regained at dawn. Charges cast spells or 1 charge creates 30-ft radius of flying insects around me for 10 min; area is heavily obscured for all others. Dispersed by strong wind. 5% chance destroyed if last charge used.",
	...
	"staff of swarming insects: drone control rod (wbw-dc-legit-sv-6)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "A steel rod tipped with a chunk of crystal computer. Hexagonal tracery lights up when it's activated & attuning to it takes 1 minute. The rod has 10 charges, 1d6+4 regained at dawn. Charges cast spells or 1 charge creates 30-ft radius of flying insects around me for 10 min; area is heavily obscured for all others. Dispersed by strong wind. 5% chance destroyed if last charge used.",
	...
	"staff of swarming insects: mariposa (wbw-dc-php-orng-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This staff was made from forgotten memories of Fidestia that don't have any homes. As a bonus action, it sheds 10-ft bright light & 10-ft more dim, or stops. When activated, glowing butterflies show a random scene of a memory. The staff has 10 charges, 1d6+4 regained at dawn. Charges cast spells or 1 charge creates 30-ft radius of flying insects around me for 10 min; area is heavily obscured for all others. Dispersed by strong wind. 5% chance destroyed if last charge used.",
	...
	"staff of thunder and lightning (ddal5-8)" : {
		...
		source : [["AL","S5"]],
		rarity : "very rare",
		description : "This +2 aspen staff shines brightly in direct light. It's almost perfectly smooth & topped with a crown of silver lightning bolts cradling a gleaming sapphire. It has 5 special options, each 1/dawn. On a hit: 'Lightning'- +2d6 Lightning; 'Thunder'- DC 17 Con or Stunned to my next turn end; 'Thunder & Lightning' - bonus action for both. Magic Action: 'Lightning Strike'- 5\xD7120ft line, DC 17 Dex, 9d6 Lightning or 1/2. 'Thunderclap'- all in 60ft, 2d6 Thunder & Deaf(1 min), DC 17 Con for 1/2 dmg.",
		...
		attunement : true,
		weight : 4,
		action: [["action", "Staff of T\u0026L: Lightning Strike, Thunderclap"], ["bonus action", "Staff of T\u0026L: Thunder and Lighting"]],
		weaponOptions : {
			baseWeapon : "quarterstaff",
	...
	"staff of thunder and lightning (ddep5-2)" : {
		...
		source : [["AL","S5"]],
		rarity : "very rare",
		description : "This giant-sized +2 staff is shaped like a bolt of lightning, and automatically resizes to fit my hands. It has 5 special options, each 1/dawn. On a hit: 'Lightning'- +2d6 Lightning; 'Thunder'- DC 17 Con or Stunned to my next turn end; 'Thunder & Lightning' - bonus action for both. Magic Action: 'Lightning Strike'- 5\xD7120ft line, DC 17 Dex, 9d6 Lightning or 1/2. 'Thunderclap'- all in 60ft, 2d6 Thunder & Deaf(1 min), DC 17 Con for 1/2 dmg.",
	...
	"staff of withering (ddex2-13)" : {
		...
		source : [["AL","S2"]],
		rarity : "rare",
		description: "This lightweight wooden staff is constantly surrounded by an unseen breeze. The winds whispers words of warning, giving me +2 to Initiative. The staff has 3 charges, regaining 1d3 at dawn & acts as a magic quarterstaff. On a hit, I can use 1 charge to deal +2d10 Necrotic to the target, who must make a DC 15 Con save or have disadv. on Str & Con ability chks & saves for 1 hour.",
	...
	"staff of withering (ddal8-13)" : {
		...
		source : [["AL","S8"]],
		rarity : "rare",
		description: "This staff is made of human bones wrapped in mithral wire. When a charge is used, my eyes alight with cosmetic black flames for a round. The staff has 3 charges, regaining 1d3 at dawn & acts as a magic quarterstaff. On a hit, I can use 1 charge to deal +2d10 Necrotic to the target, who must make a DC 15 Con save or have disadv. on Str & Con ability chks & saves for 1 hour.",
	...
	"staff of the woodlands (ccc-bmg-moon12-1)" : {
		...
		source : [["AL","CCC"]],
		rarity : "rare",
		description : "This +2 staff adds +2 to spell atks. It's made from entwined snake-like branches, 1 brown & 1 bright green. Tiny leafed branches sprout from the top of the staff: half red & gold, & half spring green. With each use, the autumn leaves fall & sprout fresh green bark & new leaves, & the spring side turns to autumn colors. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "Two entwined snake-like branches comprise the stalk of this +2 staff. One is brown and the other is bright green. The top of the staff sprouts tiny leafed branches, one side has red and gold autumn leaves and the other spring green. With each power used, the autumn leaves fall and sprout new green leaves and fresh green bark, while the green side turns brown and its green leaves turn to autumn colors. While held, I gain +2 to spell attack rolls. The staff has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands (ccc-gary-9)" : {
		...
		descriptionLong : "This +2 staff adds +2 to spell attack rolls. It's made from unblemished maple wood topped with three small white flowers in bloom & has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands (ddal7-8/ddep7-1)" : {
		...
		source : [["AL","S7"]],
		rarity : "rare",
		description : "This +2 staff adds +2 to spell atks. It's been trimmed to look like a smaller version of an immense Chultan jungle tree. There's even a small diorama of a village in the upper reaches of the staff's branches with tiny string bridges connecting tiny straw houses. It has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "This +2 staff adds +2 to spell attacks. It's been meticulously trimmed so it appears to be a smaller version of the immense jungle trees in Chult. There's even a small diorama of a tiny village in the upper reaches of the staff's branches — complete with tiny, string bridges connecting tiny, straw houses. It has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands: liwanag (wbw-dc-andl-3)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "Made from a garden plant by Alindaya as a symbol of gratitude for my deeds, this +2 staff adds +2 to spell atks. The fireflies that guided me through Andelein illuminate the staff. With a bonus action, they shed 10-ft bright light & 10-ft more dim, or stop. I can't get lost in Andelein as the fireflies guide me where I wish to go. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
	...
	"staff of the woodlands: temperate (wbw-dc-conmar-6)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This +2 staff adds +2 to spell atks. The braid of bone ends in antlers emerging from a nest of oak leaves & acorns. It's warm to the touch & smells of rich earth. (If I fought the Childe) The staff was once infused with the glow of Turanok's love for his daughter, now gone after she wielded it against him. A shadow of its former self, the staff holds a sliver of nature's power. I'm unharmed by extreme temps past 0\u00B0F & 100\u00B0F. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "This +2 staff adds +2 to spell attack rolls. The braid of bone ends with antlers emerging from a nest of oak leaves & acorns. It's warm to the touch & smells of rich earth. (If I fought the Childe) The staff was once infused with the searing glow of Turanok's love for his daughter, now gone after she wielded it against him. A shadow of its former self, the staff still holds a sliver of nature's power. While attuned, I'm unharmed by extreme temperatures past 0\u00B0F and 100\u00B0F. It has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands (wbw-dc-havn-1)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This staff, once gnarled & sickly, now sprouts with bioluminescent flowers. As a bonus action, the flowers glow with a beautiful blue that sheds 10-ft bright light & 10-ft more dim, or stop. The +2 staff adds +2 to spell atk rolls & has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic if last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "This staff, once gnarled and sickly, now sprouts with flowers after being dipped in the poison cure. The flowers are bioluminescent and can be made to glow with a beautiful blue light as a bonus action. When glowing, it sheds 10 ft bright light & 10 ft dim. The +2 staff adds +2 to spell attack rolls & has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands: guardian (wbw-dc-hh-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This +2 staff adds +2 to spell atks & gives +2 to Initiative unless I'm Incapacitated. Crafted by the Lady of The Lake herself from the oldest tree in Monster Timberland & imbued by the power of the forest, it's given to those who pass the Trial of Flower. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "Crafted by the Lady of The Lake herself, this staff is made from the branch of the oldest tree in Monster Timberland and imbued by the power of the forest. Gifted to those who passed the Trial of Flower. This +2 staff adds +2 to spell attack rolls & warns me, granting a +2 bonus to Initiative unless Incapacitated. It has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands (wbw-dc-idl1)" : {
		...
		descriptionLong : "This +2 quarterstaff adds +2 to spell atks & I hear a fragment of an ancient song about birds when it strikes. There's a Sylvan counting rhyme carved along its length: “One for Sorrow, Two for Joy/Three For a Girl, Four for Boy/Five for Silver, Six for Gold/Seven for a Secret Never to be Told.” When turned upsidedown, it reads: “One for Sorrow, Two for Mirth/Three For a Funeral, Four for Birth/Five for Heaven, Six for Hell/Seven for the Devil, His Own Self.” The staff has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands (wbw-dc-php-lcl-1)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This +2 oak staff adds +2 to spell atks & has a bouquet of golden lilies at its top. I can change the color of the lilies as an action, reverting back at dawn. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic if last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert. The tree has golden leaves & emits a pleasant floral scent.",
		descriptionLong : "This +2 staff adds +2 to spell atks & is made of oak. At its top is a bouquet of golden lilies. I can change the color of the lilies as an action, but they revert back at dawn. The staff has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff. In its tree form, the leaves are golden and emits a pleasant, floral scent.",
	...
	"staff of the woodlands: hope's emissary (wbw-dc-rook-3-2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This +2 white wood staff adds +2 to spell atks & once belonged to Valmoira Hopeblossom. It was loaned to the ruler of Cnocglen, who vowed to keep it safe until her return. The staff is carved top to bottom with images of rare animals & plants, & unlocks employee doors in the Rookery, such as the Visitor's Center, the Observatory & the Engineworx. The staff has 6 charges for spells, regaining 1d6 at dawn; 5% chance of losing magic if last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "This +2 white wood staff adds +2 to spell atks. It once belonged to Valmoira Hopeblossom herself & was loaned to the ruler of Cnocglen, who vowed to keep it safe until her return. The staff is carved top to bottom with images of rare animals & plants, & unlocks employee doors within the Rookery, including the Visitor's Center, the Observatory & the Engineworx. The staff has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
	...
	"staff of the woodlands: sunlit (wbw-dc-sunlit-6)" : {
		...
		descriptionFull : "Minor property Compass. You can take a Magic action to learn which way is magnetic north. Nothing happens if this property is used in a location that has no magnetic north.\n   This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls made with it. While holding it, you have a +2 bonus to spell attack rolls.\n   The staff has 10 charges for the following properties. It regains 1d6+4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff loses its properties and becomes a nonmagical quarterstaff.\n   " + toUni("Spells") + ". You can use an action to expend 1 or more of the staff's charges to cast one of the following spells from it, using your spell save DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges).\n   You can also use an action to cast the Pass Without Trace spell from the staff without using any charges.\n   " + toUni("Tree Form") + ". You can use an action to plant one end of the staff in fertile earth and expend 1 charge to transform the staff into a healthy tree. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius. The tree appears ordinary but radiates a faint aura of transmutation magic if targeted by Detect Magic. While touching the tree and using another action to speak its command word, you return the staff to its normal form. Any creature in the tree falls when it reverts to a staff.",
		attunement : true,
		weight : 4,
		prerequisite : "Requires attunement by a druid",
		prereqeval : function(v) { return classes.known.druid ? true : false; },
	...
	"staff of the woodlands: delver's (wbw-dc-zep-t2s2)" : {
		...
		source : [["AL","WBW-DC"]],
		rarity : "rare",
		description : "This +2 staff adds +2 to spell atk rolls & while underground, I always know my depth below the surface & the direction to the nearest path leading upward. The staff has 6 charges for spells (see sheet), regaining 1d6 at dawn; 5% chance of losing magic when last charge used. As Magic action, plant it into the earth & use 1 charge to grow it into a 60 ft tree. Repeat action to revert.",
		descriptionLong : "This +2 staff adds +2 to spell attack rolls & while underground, I always knows my depth below the surface and the direction to the nearest staircase, ramp, or other path leading upward. The staff has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
		descriptionFull : "This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls made with it. While holding it, you have a +2 bonus to spell attack rolls.\n   While underground, you always know the item's depth below the surface and the direction to the nearest staircase, ramp, or other path leading upward.\n   The staff has 10 charges for the following properties. It regains 1d6+4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff loses its properties and becomes a nonmagical quarterstaff.\n   " + toUni("Spells") + ". You can use an action to expend 1 or more of the staff's charges to cast one of the following spells from it, using your spell save DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges).\n   You can also use an action to cast the Pass Without Trace spell from the staff without using any charges.\n   " + toUni("Tree Form") + ". You can use an action to plant one end of the staff in fertile earth and expend 1 charge to transform the staff into a healthy tree. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius. The tree appears ordinary but radiates a faint aura of transmutation magic if targeted by Detect Magic. While touching the tree and using another action to speak its command word, you return the staff to its normal form. Any creature in the tree falls when it reverts to a staff.",
		attunement : true,
		weight : 4,
		prerequisite : "Requires attunement by a druid",
		prereqeval : function(v) { return classes.known.druid ? true : false; },
	...
	"staff of the woodlands: dragon's seed (wbw-dc-zodiac-5)" : {
		...
		descriptionLong : "This +2 staff is shaped & weaved from the scales of an amethyst dragon & encrusted with sea gemstones. It adds +2 to spell attack rolls & warns me, granting a +2 bonus to Initiative unless Incapacitated. It has 6 charges, regaining 1d6 at dawn. If the last charge is used, roll a d20. On a 1 it turns nonmagical. I can use charges to cast spells using my DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Pass Without Trace (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges). I can also use 1 charge & Magic action to plant the staff in earth & turn it into a 60 ft tree. It has a 5-ft-diameter trunk & a 20-ft radius of branches at the top. Repeat action while touching the tree to return it to a staff.",
		descriptionFull : "A staff shaped and weaved from the scales of an amethyst dragon and encrusted with sea gemstones. Guardian Minor Property: The item roars a warnings to its bearer, granting a +2 bonus to your Initiative rolls if you don't have the Incapacitated condition.\n   This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls made with it. While holding it, you have a +2 bonus to spell attack rolls.\n   The staff has 10 charges for the following properties. It regains 1d6+4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff loses its properties and becomes a nonmagical quarterstaff.\n   " + toUni("Spells") + ". You can use an action to expend 1 or more of the staff's charges to cast one of the following spells from it, using your spell save DC: Animal Friendship (1 charge), Awaken (5 charges), Barkskin (2 charges), Locate Animals or Plants (2 charges), Speak with Animals (1 charge), Speak with Plants (3 charges), or Wall of Thorns (6 charges).\n   You can also use an action to cast the Pass Without Trace spell from the staff without using any charges.\n   " + toUni("Tree Form") + ". You can use an action to plant one end of the staff in fertile earth and expend 1 charge to transform the staff into a healthy tree. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius. The tree appears ordinary but radiates a faint aura of transmutation magic if targeted by Detect Magic. While touching the tree and using another action to speak its command word, you return the staff to its normal form. Any creature in the tree falls when it reverts to a staff.",
		attunement : true,
		weight : 4,
		prerequisite : "Requires attunement by a druid",
		prereqeval : function(v) { return classes.known.druid ? true : false; },
...
MagicItemsList["al swords"] = {
	...
	"ascendant amethyst dragon's wrath longsword: the first sword (po-bk-3-11)" : {
		...
		weaponOptions : [{
			...
			source : [["AL","PO"]],
			description : "Versatile (1d10), sap; +3d6 force dmg; on a 20, 5 force to any creature in 5ft",
			modifiers : [3,3],
			selectNow : true
			},{			
	...
	"dancing longsword: antgaladion (wbw-dc-aa-ashalon-1)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "The blade of this elegantly curved elven longsword is made of the sharpest coldest ice from the domain of Aesandoral the Ice Lord. Quick as the blizzard winds, I can attune in 1 min. With a bonus action, toss the sword & say “Long may winter reign” to make it hover, fly up to 30 ft & atk a target (as if by me). I can have it move & attack again as a bonus action while in 30 ft. After 4th atk, it moves 30 ft to return to my hand.",
	...
	"defender greatsword: deathshield (ddal9-20)" : {
		...
		rarity : "legendary",
		attunement : true,
		description : "This magic greatsword is made out of crude black iron. Inscribed upon the blade in Abyssal is the name “Deathshield.” I have a +3 bonus to atk & dmg rolls made with this sword. The 1st time I attack with it on each of my turns, I can transfer any part of the bonus to AC instead. This AC adjustment remains in affect until my next turn, although I must be holding the sword to gain it.",
	...
	"flame tongue longsword: velahr'kerym (ddal0-2d)" : {
		...
		type : "weapon (any melee weapon)",
		rarity : "rare",
		description : "This mithril longsword has a beautiful ironwood hilt. The crossguard, blade & hilt have a forest motif inlaid with shining emeralds & platinum filigree. Delicate blue flames dance along the blade when drawn, which can be ignited with a bonus action. While lit, it deals +2d6 Fire, shedding bright light in a 40-ft radius & dim light for 40-ft more. The flames last until I repeat command (bonus action) or drop/sheathe the sword.",
	...
	"flame tongue longsword (ddal-drw13)" : {
		...
		type : "weapon (any melee weapon)",
		rarity : "rare",
		description : "This steel blade is covered in a distinctive pattern of banding & mottling reminiscent of flowing water. The patterns shift & change slowly over time. As a bonus action, say command word to make flames erupt from the blade. While lit, it deals +2d6 Fire per hit, shedding bright light in a 40-ft radius & dim light for 40-ft more. The flames last until I say the command word again (bonus action) or I drop/sheathe the sword.",
	...
	"flame tongue shortsword: flare (ccc-wyc-1-2)" : {
		...
		type : "weapon (any melee weapon)",
		rarity : "rare",
		description : "This shortsword is made of molten steel but finds its shape right before striking its target. While attuned, I'm unharmed by extreme temps past 0\u00B0F & 100\u00B0F. As a bonus action, say command (‘devastation' in Terran) to ignite the blade. While lit, it deals +2d6 Fire, shedding bright light in a 40-ft radius & dim light for 40-ft more. The flames last until I repeat command (bonus action) or drop/sheathe the sword.",
	...
	"frost brand greatsword (sj-dc-nos-4)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This magic greatsword deals +1d6 Cold dmg and grants Fire resistance when held. In freezing temps, it emits 10-ft radius bright light and 10-ft more dim. Once per hour when I draw it, I can extinguish all nonmagical flames in 30 ft. While on my person, I can speak Deep Speech.",
	...
	"frost brand greatsword: quintessence's edge (sj-dc-wine-1)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This storm silver greatsword shimmers with icy blue runes; etchings of grapevines wrap the hilt. The blade crackles with electricity on each strike & shocks me as a warning, giving +2 Initiative if not Incapacitated. It deals +1d6 Cold \u0026 gives Fire resistance when held. In freezing temps, it emits 10-ft bright light \u0026 10-ft more dim. Once per hour when I draw it, I can snuff all nonmagical flames in 30 ft.",
	...
	"frost brand longsword: blade of aaqa (sj-dc-aug-9)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "A sacred relic of the lizardfolk hunters on the gas giant Coliar, the Blade of Aaqa is freezing to the touch. Once my hand acclimates, the all-metal grip feels one with my flesh. It deals +1d6 Cold \u0026 grants Fire resistance when held. In freezing temps, it emits 10-ft radius bright light \u0026 10-ft more dim. Once per hr when I draw it, I can snuff all nonmagical flames in 30 ft.  While underground, I know my depth \u0026 the direction to the nearest path upward.",
	...
	"frost brand rapier: bitter wrath (ddal7-9)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This extraordinary weapon is made from a single piece of ice with a pommel wrapped in braided leaves. If wielded in temperatures > 90\u00B0F, rivulets of water run down the blade, soaking my hand, but it never melts away. The sword deals +1d6 Cold \u0026 grants Fire resistance when held. In freezing temps, it emits 10-ft radius bright light \u0026 10-ft more dim. Once per hr when I draw it, I can snuff all nonmagical flames in 30 ft.",
	...
	"frost brand rapier: familiar's (sj-dc-zodiac-14-3)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This dark blade shimmers and shifts as if displaced with reality, emanating an icy mist. It also warns me, giving +2 Initiative if not Incapacitated. The sword adds +1d6 Cold and grants Fire resistance when held. In freezing temps, it emits 10-ft radius bright light and 10-ft more dim. Once per hour when I draw it, I can extinguish all nonmagical flames in 30 ft.",
	...
	"frost brand shortsword: frostbite cryo katana (sj-dc-dd-11)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This ancient 8-in adamantine rod has decorative mithral plates & bands & can be attuned to in 1 min. A hollow recess housing a sliver of unmelting polar ice is ringed by a circular guard & a metal cap engraved with “FR057-B173”. Twist cap clockwise to condense ambient moisture into a faintly glowing curved blade of bluish frost. Twist the other way to sheathe. The blade deals +1d6 Cold & grants Fire resistance when held. In freezing temps, it emits 10-ft radius bright light & 10-ft more dim. Once per hr when I draw it, I can snuff all nonmagical flames in 30 ft.",
	...
	"giant slayer greatsword (ddep5-2)" : {
		...
		type : "weapon (any simple or martial)",
		rarity : "rare",
		description : "This immense +1 weapon is fashioned from crudely-forged black iron with an unfinished translucent white stone set in the pommel — engraved with the rune Dod (death). When I hit a Giant, it does +2d6 dmg & the Giant has to make a DC 15 Strength save or fall Prone.",
	...
	"greatsword of sharpness: desolation (ddal8-14)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This greatsword is made from a strange black material that feels like frigid steel. When I roll a 20 against a creature, it takes +14 Slashing & 1 lvl of Exhaustion. The sword does max damage vs objects. With a command word, the blade sheds bright light in a 10-ft radius & 10-ft more dim that only I can see. This stops if sheathed.",
		descriptionLong : "This greatsword of sharpness is made from a strange black material that feels like frigid steel. When I attack a creature and roll a 20 on the attack, that target takes an extra 14 Slashing and gains 1 level of Exhaustion. When used against an object, the damage is maximized. In addition, I can speak the sword's command word to make the blade shed bright light in a 10-foot radius and dim light for an additional 10 feet that only I can see. Speaking the command word again or sheathing the sword puts out the light.",
	...
	"greatsword of warning: ever vigilant (ccc-bmg-moon3-3)" : {
			...
			description : "This silvered greatsword has a pommel shaped like a unicorn's head & its blade is inscribed with prayers to the Earthmother. Some say it's Cymrych Hugh's legendary sword. Others say it's a reflection & the original rests with the Earthmother, awaiting a worthy hero. Allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"longsword of vengeance (ccc-bmg-moon15-2)" : {
		...
		rarity : "uncommon",
		attunement : true,
		description : "This clear crystal +1 longsword is no longer tainted by Malar's corruption. It's only loyal to me, a dull blade to anyone else, & leaves a blue-white trail in its wake when striking a target. I'm unwilling to let it go & have disadv on atks with other weapons. If I take dmg in combat, DC 15 Wis save or I must atk my attacker until they drop to 0 or I can't reach in melee. Banishment turns it into a normal +1 sword.",
	...
	"longsword of vengeance (ccc-gary-8)" : {
		...
		rarity : "uncommon",
		attunement : true,
		description : "This beautiful +1 longsword has a gold-trimmed hilt & is cursed. I'm unwilling to give it up & have disadvantage on atks with other weapons. If I take dmg in combat, DC 15 Wis save or I must atk my attacker until they drop to 0 or I can't reach in melee. Banishment turns it into a normal +1 sword.",
	...
	"longsword of vengeance (ccc-hatms1-2)" : {
		...
		rarity : "uncommon",
		attunement : true,
		description : "This cursed +1 black metal longsword has a sheen of red. The black leather-wrapped hilt ends in a pommel shaped like a human skull. It's possessed by the spirit of the orc warchief K'tagh Redeye, who urges me to violence against humans. I won't part with it & have disadv on atks with other weapons. If I take dmg in combat, DC 15 Wis save or I must atk my attacker until they drop to 0 or I can't reach in melee. Banishment turns it into a normal +1 sword.",
	...
	"longsword of vengeance (ccc-mace1-3)" : {
		...
		rarity : "uncommon",
		attunement : true,
		description : "The pommel of this cursed +1 longsword is carved into a skull wreathed in purple flames. I hear faint mumbling voices & the sword carries a hidden message I don't know how to find. I won't part with it & have disadv on atks with other weapons. If I take dmg in combat, DC 15 Wis save or I must atk my attacker until they drop to 0 or I can't reach in melee. Banishment turns it into a normal +1 sword.",
		descriptionFull : "The pommel of this sword is carved to look like a skull wreathed in purple flames. You hear faint, mumbling voices when you are attuned to the sword. The sword carries a hidden message but you have no idea how to find it.\n   You gain a +1 bonus to attack and damage rolls made with this magic weapon.\n   " + toUni("Curse") + ". This weapon is cursed and possessed by a vengeful spirit. Becoming attuned to it extends the curse to you. As long as you remain cursed, you are unwilling to part with the weapon, keeping it on your person at all times. While attuned to this weapon, you have Disadvantage on attack rolls made with weapons other than this one.\n   In addition, while the weapon is on your person, you must succeed on a DC 15 Wisdom saving throw whenever you take damage from another creature in combat. On a failed save, you must attack the creature that damaged you until you drop to 0 hit points or it does, or until you can't reach the creature to make a melee attack against it.\n   You can break the curse in the usual ways. Alternatively, casting Banishment on the weapon forces the vengeful spirit to leave it. The sword then becomes a +1 Weapon with no other properties.",
		weaponsAdd : { select : ["Longsword of Vengeance"], options : ["Longsword of Vengeance"] },
		calcChanges : {
		atkAdd: [
			function (fields, v) {
	...
	"nine lives stealer scimitar (ccc-qcc2018-1)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "The hilt of this +2 sword is covered with carved, ancient Rellanic runes that seem to comprise nonsensical words or a list of proper names. The sword has 9 charges; if it crits a creature (not construct/undead) with < 100 HP, the target makes a DC 15 Con save or dies. If it dies, 1 charge is used.",
	...
	"rapier of life stealing (ccc-pdxage-2-1)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This matte-black rapier doesn't reflect light, radiates a fiendish aura & turns chill to the touch in 30ft of a good cleric or paladin. I feel hungry even if I've eaten. When I roll a nat 20, target takes +15 Necrotic if not a Construct/Undead. I gain temp HP equal to Necrotic dealt. I also feel an invigorating euphoria & am satiated. The blade glows dully when fed.",
	...
	"scimitar of speed: deceiver (sj-dc-dfa-3)" : {
		...
		type : "weapon (scimitar)",
		rarity : "very rare",
		description : "This curved scimitar is made from a single piece of infernal iron, with no discernable hilt. When it draws blood, I feel optimistic about the future, as if I can defeat or trick any opponent. I gain +2 to the sword's atk and dmg, and can attack with it as a bonus action once per turn.",
	...
	"scimitar of speed: bregrist (wbw-dc-trey-1)" : {
		...
		type : "weapon (scimitar)",
		rarity : "very rare",
		description : "The name of this famed scimitar translates to \"quick cut\" in Common. Also known as Slicer, the finely honed blade is edged in silver and was superbly crafted by a skilled elven smith. It's inlaid with stylized silver vines that run the length of the blade and spell its name in Elvish. I gain +2 to the sword's atk and dmg, and can attack with it as a bonus action once per turn.",
	...
	"scimitar of speed: dread cutlass (sj-dc-dwr-3)" : {
		...
		type : "weapon (scimitar)",
		rarity : "very rare",
		description : "This pirate's cutlass has a long red tassel hanging from the end of its hilt. I gain a +2 bonus to the sword's atk and dmg rolls and can attack with it as a bonus action once per turn. The sword also warns me, giving +2 Initiative unless Incapacitated.",
	...
	"scimitar of warning: miir (ccc-bwm-4-1)" : {
		...
		attunement : true,
		advantages : [["Initiative", true]],
		description : "This mithral blade is exquisitely crafted from the finest materials & never becomes dirty. “Miir” means “priceless” in Elvish. While on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"sun blade: the seventh sword (ccc-6swords-1)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This sword is of unknown origin & unique design. There's no guard, only a handle with an ivory figurehead on each end: a devil & dragon. When 1-handed, the dragon's eyes glow red & a blade extends from its mouth. When 2-handed, a 2nd red blade extends from the devil. Bonus action to create/dismiss blades. While blade exists, it's a +2 finesse longsword that works with shortsword proficiency, does Radiant (+1d8 to Undead) & emits 15-ft bright sunlight & 15-ft more dim. Magic action to change by 5 ft/type (min 10/max 30).",
		descriptionLong : "This sword is of unknown origin & unique design. There is no guard, only a handle, which is adorned with ivory figureheads on either end - a devil & a dragon. When used 1-handed, the dragon's eyes glow red & a reddish blade extends from its mouth. When used 2-handed, a second blade extends from the devil's mouth, making the weapon appear like a staff. As a bonus action, I can create or dismiss a blade of pure radiance from the hilt. While the blade exists, it acts as a finesse longsword that does Radiant & grants +2 to atk & damage rolls. It also deals +1d8 Radiant to Undead & emits sunlight: bright light in a 15-ft radius & dim light for another 15-ft. As a Magic action, I can expand or reduce the bright & dim light by 5 ft each, to a maximum of 30 ft or a minimum of 10 ft each. I'm proficient with this blade if proficient with either longswords or shortswords.",
	...
	"sun blade: dawnfire (ccc-storm-1)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This ancient sword hilt is made of orichalcum & known as Dawnfire. The ruby in its pommel sheds dim light for 10 ft when undead in 60 ft. As bonus action, I can create or dismiss a blade of radiance from the hilt. While the blade exists, it acts like a +2 finesse longsword that does Radiant (+1d8 to Undead), emits 15-ft bright sunlight & 15-ft more dim. Magic action to change by 5 ft/type (min 10/max 30). Requires short or longsword proficiency.",
	...
	"sun blade: starshard (rmh-12)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "Starshard is a jagged 3-ft shard of white-stained glass that depicts half a celestial creature. It's wrapped with a bloody strip of linen as a grip. If I roll a natural 1 on an atk with Starshard, I must pass a DC 17 Con save or be blinded until my next turn ends. As a bonus action, I can create or dismiss radiant energy from the hilt. While the energy exists, it acts like a +2 finesse longsword that does Radiant (+1d8 to Undead), emits 15-ft bright sunlight & 15-ft more dim. Magic action to change by 5 ft/type (min 10/max 30). Requires short or longsword proficiency.",
	...
	"vicious longsword (ccc-hatms2-1)" : {
		...
		type : "weapon (sword)",
		rarity : "rare",
		description : "This longsword does +2d6 damage. Its scabbard is jet black with gold embellishments & the initials ‘ST' at the top. The hilt is made from gold & mithral & is set with a skull with red ruby eyes. It's wrapped with bone white cord to provide exceptional grip. When I roll a 20, I hear sinister laughter.",
	...
	"vorpal scimitar: abi teos's machete (rmh-9/rmh-10)" : {
		...
		attunement : true,
		allowDuplicates : true,
		description : "This 17-in machete is dull & chipped. Its azabache hilt is carved with leeches & blonde hair hangs from the pommel. The +3 sword's namesake wantonly cut selva & did excessive ritual sacrifice. The hilt reads “A mi, volpal”, “A blade for me.” It ignores Slashing resistance & does +2d8 to plants. When I hit, I take 1d6 Necrotic. On a 20, it cuts off 1 head (possibly = death). If target headless, immune to Slashing, too big, or uses 1 Legendary Resistance, +30 Slashing instead. On a 1, gain 1 lvl Exhaustion. Remove by DC 12 Con save on LR. If fail, gain a lvl.",
		descriptionLong : "This 17-inch machete seems dull and chipped. Its azabache hilt is carved with writhing leeches and blonde hair hangs from the pommel. The sword's namesake wantonly cut selva and conducted excessive ritual sacrifice. At the right angle, the hilt reads: “A mi, volpal” which means “A blade for me.” The +3 sword ignores Slashing resistance and does +2d8 damage to plants. When I hit, I take 1d6 Necrotic. On a 20, it cuts off 1 head (possibly causing death). If the target has no heads, is immune to Slashing, is too big (per DM), or uses 1 Legendary Resistance, +30 Slashing instead. On a 1, I gain 1 level of Exhaustion. Remove 1 level with DC 12 Con save on Long Rest. If fail, I gain another level.",
...
MagicItemsList["al weapons +1, +2, or +3"] = {
		...
		"+2 glaive: azure sky (sj-dc-angka-6)" : {
			...
			rarity : "rare",
			allowDuplicates : true,
			description : "The blade of this glaive is made from a single flawless sapphire, shimmering with a mesmerizing azure glow. Its shaft, intricately carved from the bone of an ancient wyrm, hums with power, guiding my hand with grace. I have a +2 bonus to atk and dmg rolls made with this magic weapon. The glaive also warns me, giving +2 Initiative if not Incapacitated.",
		...
		name : "Gythka, Greataxe +2 (SJ-DC-PAT-1)",
			...
			attunement : true,
			allowDuplicates : true,
			description : "A greataxe of the two-bladed thri-kreen style. Moss-ink designs etched in the handle let me suffer no harm in extreme temperatures past 0\u00B0F and 100\u00B0F. I have a +2 bonus to atk and dmg rolls made with this magic weapon.",
		...
		name : "Agony, +2 Greatsword (SJ-DC-ANGKA-1)",
			...
			rarity : "rare",
			allowDuplicates : true,
			description : "The hilt of this greatsword is wrapped in black leather. The blade is blood red & its sheath the color of red wine. Created through ritual sacrifice, this greatsword radiates the hot metallic scent of fear & the singed sulfur smell of anger. When I hold it, I hear the cries & warnings of the soul fragment trapped within, granting a +2 bonus to Initiative unless Incapacitated. I also have a +2 bonus to atk & dmg rolls made with this magic sword.",
		...
		"+2 hand crossbow (sj-dc-rock-1)" : {
			...
			rarity : "uncommon",
			allowDuplicates : true,
			description : "Mahaxara, captain of Bral's royal guard, favours this sleek and deadly hand crossbow. It's shaped like 2 intertwined snakes, etched along the stock and barrel, wih the crossbow's limbs protruding from each snake's head like deadly fangs. I gain a +2 bonus to attack and damage rolls made with the weapon. It also warns me, giving +2 Initiative unless Incapacitated.",
		...
		"+2 heavy crossbow: first blood (sj-dc-tbs-4)" : {
			...
			rarity : "uncommon",
			allowDuplicates : true,
			description : "This magic crossbow is crafted from sturdy darkwood and gold. The edges are adorned with elaborate carvings of war. It yearns for blood! I gain a +2 bonus to attack and damage rolls made with the weapon. It also warns me, giving +2 Initiative unless Incapacitated.",
		...
		"+2 longsword: westdeck sword (sj-dc-cgg-2)" : {
			...
			rarity : "rare",
				allowDuplicates : true,
			description : "The hilt of this longsword bears the sigil of House Westdeck. Viewing it from certain angles under a clear sky in the Calatas system makes it seem to take different forms. I have a +2 bonus to atk & dmg rolls made with this magic weapon. I can also use a Magic action to make my voice carry clearly for up to 600 ft until my next turn ends.",
		...
		"+2 maul: manyoshu's kanabo (fr-dc-oni-1)" : {
			...
			rarity : "rare",
			allowDuplicates : true,
			description : "This kanabo has a wooden shaft with a bulging head and is incredibly warm to the touch. The surface of the head is studded with metal nodes and the weapon is harder than steel. It warns me, granting +2 to Initiative if I'm not Incapacitated. I also have a +2 bonus to attack and damage rolls made with this magic weapon.",
		...
		"+2 war pick (ccc-myr1-1)" : {
			...
			rarity : "rare",
			allowDuplicates : true,
			description : "This war pick is fashioned from a bent remorhaz whisker, carved with intricate depictions of the great beast in action. It retains some of the beast's inherent warmth & I'm unharmed in extreme temps past 0\u00B0F & 100\u00B0F. I have a +2 bonus to atk & dmg rolls made with this magic weapon.",
			descriptionFull : "This weapon is fashioned from a bent remorhaz whisker, carved with intricate depictions of the great beast in action. It also retains some of the beast's inherent warmth. You are unharmed by temperatures of 0 degrees Fahrenheit or lower, and 100 degrees Fahrenheit or higher. It does not convey any resistance to damage. You have a +2 bonus to attack and damage rolls made with this magic weapon.",
			savetxt : { immune : ["temps past 0\u00B0F/100\u00B0F"] },
		...
		"+3 hand crossbow: belmore (wbw-dc-php-lcl-2)" : {
			...
			rarity : "uncommon",
			allowDuplicates : true,
			description : "This finely crafted hand crossbow resembles an exotic flintlock pistol with the words ‘Belmore' and ‘K.B.' engraved on the grip. It warns me, giving +2 Initiative when I'm not Incapacitated. I also gain a +3 bonus to attack and damage rolls made with this weapon.",
...
MagicItemsList["al weapons (other)"] = {
	...
	"berserker flail (ccc-ucon-1)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This battered +1 flail is notched & covered in a patina of rust & dried blood. While wielded, I have adv. on Wis (Survival) chks to track humanoids. The flail gives +1 HP per level & is cursed so it costs an extra 30 DT to trade. I can't part with it & have disadv. with other weapons. When I'm damaged by a Hostile, DC 15 Wis save or I go berserk, using my action & move each round to atk the closest creature w/ the flail until none visible/audible in 60 ft.",
		descriptionLong : "This battered flail is notched & covered in a patina of rust & dried blood. While wielded, I have advantage on Wis (Survival) checks to track humanoids. The flail gives +1 to attack and damage rolls, +1 HP per level & is cursed so it costs an extra 30 DT to trade. I can't part with it willingly & have disadvantage with other weapons. When I'm damaged by a Hostile creature, DC 15 Wis save or I go berserk, using my action & move each round to attack the closest creature with the flail until no one is visible or audible in 60 ft.",
	...
	"dagger of venom: fang of sibyl (ccc-gary-1)" : {
		...
		type : "weapon (dagger)",
		rarity : "rare",
		description : "This stylized +1 dagger is etched with symbols that appear religious, but are impossible for even the most educated scholar to identify. As a bonus action once per dawn, I can coat it with poison, lasting 1 min or until I hit a creature. That creature makes DC 15 Con save or takes 2d10 Poison and Poisoned for 1 min.",
	...
	"dagger of venom (ddal4-11)" : {
		...
		type : "weapon (dagger)",
		rarity : "rare",
		description : "This +1 dagger appears as a knot of vipers, their tails the pointed blade & heads forming the hilt & guard. I hear hissing snakes when in 120 ft of poison or venomous creatures. As a bonus action once per dawn, I can coat it with poison, lasting 1 min or until I hit a creature. That creature makes DC 15 Con save or takes 2d10 Poison and Poisoned for 1 min.",
	...
	"dagger of venom (ddal5-17)" : {
		...
		type : "weapon (dagger)",
		rarity : "rare",
		description : "The pommel of this wicked +1 dagger looks like a black viper with the forked blade resembling its tongue. As a bonus action once per dawn, I can coat it with poison, lasting 1 min or until I hit a creature. That creature makes DC 15 Con save or takes 2d10 Poison and Poisoned for 1 min.",
	...
	"elven thrower (fr-dc-death)" : {
		...
		weaponOptions : {
			...
			name : "Elven Thrower",
			range : "Melee, 20/60 ft",
			description : "Thrown, versatile (1d8), sap; +1d8 damage when thrown (2d8 vs. giants) and returns immediately",
			modifiers : [3, 3],
			selectNow : true,
		}
	},
	...
	"flame tongue (ccc-ylra-2)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This magic weapon was crafted for me by the expert smiths at the Emberstar Exchange to my specifications. As a bonus action, I can say the command word to ignite it, emitting bright light in a 40-ft radius & dim light for 40-ft more. While ablaze, the weapon deals +2d6 Fire dmg per hit. The flames last until I say the command again as a bonus action, drop, stow or sheathe it.",
		descriptionFull : "This weapon was crafted for you by the expert smiths at the Emberstar Exchange to your specifications. While holding this magic weapon, you can take a Bonus Action and use a command word to cause flames to engulf the damage-dealing part of the weapon. These flames shed Bright Light in a 40-foot radius and Dim Light for an additional 40 feet. While the weapon is ablaze, it deals an extra 2d6 Fire damage on a hit. The flames last until you take a Bonus Action to issue the command again or until you drop, stow, or sheathe the weapon. [Updated choices to include any melee weapon as per the new DMG]",
		action : [["bonus action", "Flame Tongue (activate/end)"]],
		chooseGear : {
			type : "weapon",
			prefixOrSuffix : "brackets",
	...
	"glaive of warning: the harbinger (ccc-epi1-2)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This massive scythe, the Harbinger, was forged from the darkest shadows of the plane of Gehenna, home of the orcish god Shaargas. It's light & doesn't cast a shadow, though shadows warn me of impending danger. While it's on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"glaive of warning: losspatan's war-scythe (ccc-ggc-2-1)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This war-scythe consists of a reddish 10-ft wooden pole with a curved scythe-like blade at the top that's etched with infernal runes. Along the base of the pole is the preserved tail of a fiendish creature, which emanates a foul odor of rot. When trouble is nearby, the tail whips & thrashes to warn of impending danger. Allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"greatclub of warning: u'u war club (wbw-dc-den-h2)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "From a distant prime material land called the Marquesas Islands, the U'u War Club is carved from ironwood, sennit & human hair. A Marquesan warrior or chief carried this greatclub as a sign of status. The carvings of faces & eyes keep watch in all directions & symbolize a warrior's ancestors, endowing them with spiritual power & protection. Allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"green-flame mace: face of umberlee's fury (ccc-awe-1-2)" : {
		...
		weaponOptions : {
			...
			description : "Sap; Counts as magical; +1 fire dmg while lit",
			selectNow : true,
		}
	},
	"javelin of lightning (ccc-bfg1-3)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin has the symbol of Selûne embossed onto the head. Once per dawn I can speak the javelin's command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
		...
		weaponOptions : {
			...
			description : "Thrown, slow; Once per dawn special attack, see description",
			selectNow : true,
		}
	},
	"javelin of lightning (ccc-bmg-moon6-3)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin crackles with energy that changes color to match my mood. Once per dawn I can speak the javelin's command word & make a ranged weapon atk at target in 120 ft. It changes into an streak of rainbow lightning as it flies through the air. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (ccc-bmg-moon16-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "The blackened wood of this javelin was taken from a tree struck by lightning. Once per dawn I can say the javelin's command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. The lightning bolt is black & sends a chill through my body. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (ccc-sac-4)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "Once per dawn, I can speak this javelin's command word & make a ranged weapon atk against a target in 120 ft. It turns into a lightning bolt & a minor storm appears above it, soaking all things in its path before dissipating. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (ccc-sfbay-4-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "The shaft of this javelin is crafted from fine ash wood while the point is shining steel. Runes etch the point & the air smells faintly of ozone before it's thrown. Once per dawn I can say its command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (ddal8-5)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin glows an angry red when within 120 feet of a troll. Once per dawn I can speak its command word and make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (sj-dc-as-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin is a magic weapon. Once per dawn, speak this javelin's command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand. The javelin makes a sonic boom when used.",
	...
	"javelin of lightning: comet spear (sj-dc-cjk2-2)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "Several adventurers pooled skills and resources to craft me a special weapon. Once per dawn, speak this javelin's command word & make a ranged weapon atk at a target in 120 ft. The spear turns into a glittering silver comet wreathed in electric fire. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand. I can also use a Magic action to make my voice carry clearly for up to 600 ft until my next turn ends.",
	...
	"javelin of lightning: stormstrike (sj-dc-dd-4)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This short-hafted bident is made of the same smooth black metal as the Monad & glows when undead are in 120 ft. “5702M5721KE” is engraved on the haft & when I press a button, lightning crackles along the tines. Once per dawn, speak the command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning: rrakkma's smite (sj-dc-flumph-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This obsidian & silver-blue javelin radiates sparks of electricity when it makes contact with metal or flesh & the phrase ‘Rrakkma' is etched into the metal in Gith. It crackles & shocks warnings, giving +2 Initiative unless Incapacitated. Once per dawn, speak the command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning: jensen's lure (sj-dc-isl-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin's well-worn wood is dyed in stripes of magenta & green by years of exposure to Isl's algae. As a bonus action, I can activate or stop the algae's bioluminescence with the javelin's energy, creating a 10-ft radius of bright light & 10-ft dim. Once per dawn, speak command word & make a ranged weapon atk at target in 120 ft. Anyone between me & target in 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (sj-dc-triden-upr)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This crystalline blue javelin is indestructible while it retains its magical lightning attack. Once per dawn, speak the command word & make a ranged weapon attack at a target in 120 ft. Anyone between me & the target in a 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of lightning (sj-dc-ttuc-1)" : { // contains contributions by Larry Hoy
		...
		type : "weapon (javelin)",
		rarity : "uncommon",
		description : "This javelin was created by a Gnomish tinkerer & lets me speak Gnomish. Once per dawn, speak the command word (Godspeed in Gnomish) & make a ranged weapon attack at a target in 120 ft. Anyone between me & the target in a 5-ft wide line takes 4d6 Lightning, DC 13 Dex save halves. If the javelin hits, the target takes 1d6 Piercing & 4d6 Lightning. It then reappears in my hand.",
	...
	"javelin of warning: jeny's hairpin (ccc-vote-1-1)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This magical javelin resembles a giant hairpin made of purple wood, with a fist-sized jet at its head. Warnings of danger in Jeny's voice shout for me to prepare for battle. I can't say whether it's the weapon or Jeny herself. While on my person, I feel discomfort and distaste but allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"longbow of melodies: lavender's scent (fr-dc-pandora-jwei-10)" : {
			...
			rarity : "very rare",
			attunement : true,
			description : "This longbow is shaped like a harp with multiple strings. When strummed, it emits an aroma of lavender and those who fall asleep while enchanted by its melodies are blessed with tranquil dreams. The bow also warns me, giving +2 Initiative if not Incapacitated. I can use the strings to play 1 melody on each atk. Melody of Precision: If proficient with Performance, add +1 (+2 if expertise) to the atk roll. Melody of Reverberation: add Charisma modifier in Thunder dmg to atk.",
	...
	"mace of disruption (ccc-cic-3)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "This black metal mace is decorated with holy symbols of Auril, Talos, & Velsharoon. While held, it sheds a 20-ft radius bright light & 20-ft more dim. This light flickers like lightning & generates occasional swirls of snowflakes. The mace does +2d6 Radiant to Fiends & Undead. If they're left with under 26 HP, DC 15 Wis save or die. If pass, Frightened of me until my next turn ends.",
	...
	"mace of disruption: death's head (ccc-ghc-bk1-2)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "This mace has a long stout handle wrapped in black leather. The top is a skull with curved ram horns & a screaming mouth. I can attune in 1 min. It sheds 20-ft bright light & 20-ft more dim. Golden sparks burst forth when the mace hits Fiends or Undead, doing +2d6 Radiant & sounding an ominous bell toll. If they're left under 26 HP, DC 15 Wis save or die. If pass, Frightened of me until my next turn ends.",
	...
	"mace of smiting (ddal7-6)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "The once-fine haft of this magical mace has gone to soggy rot; even the leather wrapping its pommel doesn't stop it from soaking through my gloves. The metal head is carved into the giant rune Rün (ruin). Upon striking a construct, it unleashes a shower of gold sparks. The mace adds +1 (+3 vs Constructs) to atk & dmg. On a 20 to hit, the target takes +7 Bludgeoning (+14 to Contructs). If Construct left with under 26 HP, it dies.",
		descriptionFull : "The once-fine haft of this club has long-since gone to soggy rot; even the leather wrapping its pommel isn't enough to stop it from soaking through the wearer's gloves. The adamantine head of the mace is carved to resemble the giant rune Rün (ruin). Upon striking a construct with the mace, it unleashes a shower of gold sparks.\n   You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon. The bonus increases to +3 when you use the weapon to attack a Construct.\n   When you roll a 20 on an attack roll made with this weapon, the target takes an extra 7 Bludgeoning damage, or 14 Bludgeoning damage if it's a Construct. If a Construct has 25 Hit Points or fewer after taking this damage, it is destroyed. [Per magic item changes, adamantine is now flavor only]",
		weight : 4,
		weaponOptions : {
			baseWeapon : "mace",
	...
	"mace of smiting (ddal8-7)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "This head of this mace features an angry dwarven face. The ghost of Reizzlerum Caskview still maintains a connection to it, giving me an unending thirst for good ale. As I grow intoxicated, the face looks more drunkenly joyful. The longer I go without a drink, the angrier the face looks. The mace adds +1 (+3 vs Constructs) to atk & dmg. On a 20 to hit, the target takes +7 Bludgeoning (+14 to Contructs). If Construct left with under 26 HP, it dies.",
	...
	"mace of smiting (ddal10-7)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "This mace is formed from a single piece of obsidian. \"Those willing to deny themselves the radiance of the stars would be better to pluck out their eyes & cast them away\" is inscribed over & over in Draconic around the haft. The mace adds +1 (+3 vs Constructs) to atk & dmg. On a 20 to hit, the target takes +7 Bludgeoning (+14 to Contructs). If Construct left with under 26 HP, it dies.",
	...
	"mace of terror: durgeddin's fist (ddep6-1)" : {
		...
		rarity : "rare",
		type : "weapon (mace)",
		description : "Wrought of blackened steel, the head of this mace is shaped like 3 screaming orc skulls. When wielded vs orcs, Durgeddin's Fist bellows profanities & insults in a fearsome baritone audible for 30'. The mace has 3 charges, 1d3 regained at dawn. Magic action: 1 charge - all chosen creatures in 30ft make DC 15 Wis save or Frightened of me for 1 min, repeats at end of turns. While Frightened, can only Dash away (or free self), Dodge if can't move, no Opp Atks.",
		descriptionLong : "Wrought of blackened steel, the head of this mace is forged in the likeness of 3 screaming orc skulls. When wielded in combat against orcs, Durgeddin's Fist bellows an endless stream of profanities and insults in a fearsome dwarven baritone audible for 30'. This mace has 3 charges, 1d3 regained at dawn. As a Magic action, I can use 1 charge to have each creature of my choice within 30 ft make a DC 15 Wis save or become Frightened of me for 1 minute. While Frightened, a creature must try to move as far from me as it can, using its action only to Dash or escape restraints, & can't make Opportunity Attacks. If it has nowhere to move, the creature can Dodge instead. It repeats the save at the end of each turn, ending the effect on a success.",
	...
	"oathbow (ddal-drw8)" : {
		...
		type : "weapon (longbow or shortbow)",
		rarity : "very rare",
		description : "This bow is made of blackened, cooled lava, its string glowing as if red-hot. It whispers 'Swift defeat to my enemies' when nocked. If I atk with bow & say command, target is sworn enemy for 7 days or until death (ability recharges next dawn). Bow atks vs it get advantage, +3d6 dmg, ignore partial cover & no range disadv. While it lives, disadv. with other weapons.",
	...
	"oathbow: selestria (wbw-dc-tmp-3)" : {
		...
		type : "weapon (longbow or shortbow)",
		rarity : "very rare",
		description : "Selestria is strung with unicorn hair & made from the heartwood of an elder treant dedicated to protecting the forest. The bow mutters Elvish prayers to Mielikki & grumbles in cities about being far from nature. If I listen carefully, I may learn something. If I atk with bow & say command, target is sworn enemy for 7 days or death (ability recharges next dawn). Bow atks vs it: adv, +3d6 dmg, ignore partial cover & no range disadv. While it lives, I have disadv. with other weapons.",
	...
	"shortbow of melodies (fr-dc-fall-1)" : {
			...
			rarity : "very rare",
			attunement : true,
			description : "This shortbow is shaped like a harp with multiple strings. It's the color of Auril's rime and always cool to the touch. While on my person, I suffer no harm in extreme temps past 0\u00B0F & 100\u00B0F. I can use the strings to play 1 melody per atk. Precision: If proficient with Performance, add +1 (+2 if expertise) to atk roll. Reverberation: add Charisma mod Thunder dmg.",
	...
	"trident of fish command (ccc-bmg-moon14-1)" : {
		...
		type : "weapon (trident)",
		rarity : "uncommon",
		description : "This trident is made of porous blackened lava rock, seemingly hot to the touch. When used underwater, schools of tiny brightly colored fish encircle me & refuse to leave no matter. The trident has 3 charges & regains 1d3 at dawn. While carried, I can use 1 charge to cast Dominate Beast (save DC 15) from it on a Beast with an innate swim speed.",
	...
	"trident of fish command (ccc-tarot2-8)" : {
		...
		type : "weapon (trident)",
		rarity : "uncommon",
		description : "This beautiful magic trident is made from pure pearl, likely carved from the treasure of a massive oyster. Delicate lines along its prongs & shaft blend imagery of strong winds & calm seas. The trident has 3 charges & regains 1d3 at dawn. While carried, I can use 1 charge to cast Dominate Beast (save DC 15) from it on a Beast with an innate swim speed.",
	...
	"trident of fish command (ccc-wwc-2)" : {
		...
		type : "weapon (trident)",
		rarity : "uncommon",
		description : "This ornate magic trident is made from solid bone. Its shaft is covered in carvings of fish & other sea creatures. Despite its time underwater, it's unstained with no signs of wear. The trident has 3 charges & regains 1d3 at dawn. While carried, I can use 1 charge to cast Dominate Beast (save DC 15) from it on a Beast with an innate swim speed.",
	...
	"trident of warning (ddex2-3)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "Anyone wielding this weapon of unusual, blue steel feels oddly self-assured. While it's on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"trident of warning (ccc-tri-34)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This white trident is made from whale bones, laced together with dried tendons. While on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"weapon of warning (ccc-elf-3-1)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This iron weapon is of fine gnomish make & gives me a fascination with tinkered contraptions. While on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"weapon of warning (ddal0-7)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This length of black iron is wrapped in supple, black leather & gilt in mithral. While wielding this weapon, profane fiery runes of pain & hate appear on the arm that holds it. Allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"whip of warning (ccc-ghc-bk2-10)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "The handle of this whip is emblazoned with a skeletal bat, wings stretched out over a crescent moon with the tips pointed upward. While on my person, allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
	...
	"whip of warning (ddal4-2)" : {
			...
			attunement : true,
			advantages : [["Initiative", true]],
			description : "This whip is made from a length of rotting, thorn-covered vine set into a handle of unusual purple wood. The pommel is a large chunk of unpolished amber with a moving eyeball trapped inside. Allies in 30 ft and I have adv. on Initiative rolls. The weapon also magically awakens us from nonmagical sleep when combat starts.",
