...
/*	prereqeval : function(v) { return (/elf|avariel|grugach|shadar-kai/i).test(CurrentRace.known); },*/ //Pre-reqs don't work on backgrounds currently. Leaving this code here as an example in case that changes at some point.
eval : function () {
...
//Making these standalone backgrounds since the originals lost their bonds/features/traits
...
AddBackgroundVariant("city watch", "knight of the order", {
