...
FeatsList["al story awards"] = {
	...
	"blessing of wound closure (sj-dc-mist-1)" : {
		...
		source : [["AL","SJ-DC"]],
		description : "With this blessing, I'm permanently marked with a faint ghostly handprint somewhere on my body. I also stabilize whenever I am dying at the start of my turn. In addition, whenever I roll a Hit Die to regain hit points, I double the number of hit points it restores.",
		descriptionFull : "Characters with this blessing a permanently marked with a faint, ghostly handprint somewhere on their body.\n   This blessing grants you the benefits of a Periapt of Wound Closure. You stabilize whenever you are dying at the start of your turn. In addition, whenever you roll a Hit Die to regain hit points, you double the number of hit points it restores.",
	},
    ...
    "boon of skill proficiency: star power (ps-dc-ravengard)": {
		...
		source : [["AL","PS-DC"]],
        description: "\"Everyone’s seen it, you badass action movie star you. Did you really do those things? Doesn’t matter. They believe you did. They believe you can. That counts for a lot.\" I gain proficiency in all skills.",
		descriptionFull: "\"Everyone’s seen it, you badass action movie star you. Did you really do those things? Doesn’t matter. They believe you did. They believe you can. That counts for a lot.\" You gain proficiency in all skills.",
...
changeeval : function () {
 ...
 removeeval : function () {
	...
	"nettle (ddep4)" : {
		...
		description : "This sentient +2 hand crossbow has seen better times. The wood is cracked & splintered & the string is heavily-frayed. A large, blue feather hangs from the handgrip alongside a couple green glass baubles. The crossbow whispers warnings, granting a +2 bonus to initiative unless incapacitated. Sentience: Chaotic Neutral. Hearing & Darkvision to 120 ft. Speaks Common & Halfling. Personality: Greedy, impetuous, demands to be polished or shouts insults & denies bonuses.",
	...
	"oathbinder (ddhc-toa-15)" : {
		...
		description : "Handed down through generations of holy warriors, Oathbinder is a sentient +2 warhammer fashioned from gold, jade, & finished wood. When I hit fiends/undead, they take an extra 2d6 radiant dmg. If left w/ 25 hp or less, must pass a DC 15 Wisdom save or die. On a pass, the creature is frightened until my next turn ends. While holding Oathbinder, it sheds 20-ft bright light & 20-ft dim. I can also cast Beacon of Hope once per dawn. If I flee from extraplanar evil, Oathbinder mocks my cowardice.",
		descriptionLong : "Handed down through generations of holy warriors, Oathbinder is a sentient +2 warhammer fashioned from gold, jade, and finished wood. When I hit a fiend or undead, they take an extra 2d6 radiant. If this leaves them with 25 hp or less, they must pass a DC 15 Wisdom save or die. On a pass, the creature is frightened until my next turn ends. hile held, Oathbinder sheds 20-ft radius bright light and 20-ft dim. I can also cast Beacon of Hope once per dawn. Imbued with the lifeforce of an ancient celestial, Oathbinder is the sworn enemy of fiends and other evil extraplanar creatures. It speaks only when it has something important to say, and can often be openly curt and matter-of-fact when doing so. If I flee from extraplanar evil, Oathbinder mocks my cowardice.",
