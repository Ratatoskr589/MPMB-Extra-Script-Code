...
MagicItemsList["al adamantine/mithral armor"] = {
	...
	"adamantine chain shirt (ccc-bmg-moon3-2)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "F",
		description : "This armor shows no signs of age. It gleams brightly, showing off the fine runework that contains Bronwyn Rookoath's personal emblem. It's reinforced with adamantine and when worn, any critical hit against me becomes a normal hit.",
	...
	"adamantine chain shirt (ccc-pdxage-1-1)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "F",
		description : "This magical armor is crafted from adamantine, and is made with superb dwarf craftsmanship. While worn, any critical hit against me becomes a normal hit.",
	...
	"adamantine chain shirt (ddep5-2)" : {
		...
		source : [["AL", "S5"]],
		magicItemTable : "F",
		description : "This glittering chain shirt is composed of interlocking adamantine rings. When I move, the shirt emits the faint sound of waves lapping at the shore. While worn, any critical hit against me becomes a normal hit.",
	...
	"adamantine chain mail (ccc-bmg-moon5-1)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "F",
		description : "Made by fomorians for a demonic subordinate, this armor crackles with hellish energy & is marked with Yeenoghu's symbol. The symbol can be removed by hand, but the faint smell of blood never comes out. While worn, any critical hit against me becomes a normal hit.",
	...
	"adamantine plate: durgeddin's unbreakable auspice (ddep6-1)" : {
		...
		source : [["AL", "S6"]],
		magicItemTable : "H",
		description : "A masterwork of dwarven craftsmanship, this plate mail is forged of pure adamantine and lovingly adorned with all the holy symbols of the Dwarven Pantheon etched in platinum about the breastplate. While worn I have advantage on all social interactions with dwarves and any critical hit against me becomes a normal hit.",
	...
	"mithral chain mail (ccc-saf2-1)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "F",
		description : "Mithral is a light, flexible metal, and this chain mail doesn't impose disadvantage on Dex (Stealth) checks. While wearing it, I also suffer no harm in temps from -20\u00B0F to 120\u00B0F.",
	...
	"mithral splint (ccc-des-2-2)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "B",
		description : "Stylized into the plates & embossed on the gauntlets of this armor is the symbol of Torin Nomerthal, the former First Lord of Hillsfar. This tyrannical leader reinstated the “Great Law of Humanity” that barred nonhumans from entering the city. While wearing this armor, I suffer disadvantage on Charisma checks against creatures who opposed the law. Mithral is a light, flexible metal, & this splint doesn't impose disadv. on Dex (Stealth) checks or require 15 Str.",
...
MagicItemsList["al armor +1, +2, +3"] = {
	...
	"+1 breastplate (sj-dc-asi-3)" : {
		...
		magicItemTable : "H",
		allowDuplicates : true,
		description : "This armor was recovered from the fallen githyanki Vaa'len. The intricately forged dark metal accentuates my musculature and bands of inlayed silver highlight the magical patterns. This breastplate grants a +1 bonus to AC while worn and whispers warnings, giving +2 initiative if I'm not incapacitated.",
	...
	"+3 studded leather (ps-dc-ss)" : {
		...
		magicItemTable : "I",
		allowDuplicates : true,
		description : "This black studded leather armor is made from the hide of a Far Realm monstrosity and grants a +3 bonus to AC while worn. The hide’s exposure to the Far Realm protects me from harm in temperatures from -20\u00B0F to 120\u00B0F. If the armor is flipped inside out, a game of tic-tac-toe using the letters “M” and “E” is visible. ",
	...
	"+3 plate (ps-dc-aug-1)" : {
		...
		magicItemTable : "I",
		allowDuplicates : true,
		description : "This plate armor was recovered from the ursine archons that guard the gate to Mount Celestia and still smells of bear. It grants a +3 bonus to AC while worn and whispers warnings, giving +2 initiative when I'm not incapacitated.",
		descriptionFull : "This plate armor was recovered from the ursine archons that guard the gate to Mount Celestia. It still smells of bear.\n   " + toUni("Guardian") + ". The item whispers warnings to its bearer, granting a +2 bonus to initiative if the bearer isn't incapacitated. The armor resizes to fit its wearer.\n   You have a +3 bonus to AC while wearing this armor.",
		addMod : { type : "skill", field : "Init", mod : 2, text : "+2 bonus on initiative rolls." },
...
MagicItemsList["al armor (common)"] = {
	...
	"cast-off breastplate (dc-poa-conmar-6)" : {
		...
		source : [["AL", "DC-POA"]],
		type : "armor (medium)",
		description : "This breastplate is dark blue with the symbol of Auril the Frostmaiden (white snow crystals) engraved into the metal. I can doff it as an action.",
	...
	"cast-off breastplate (dc-poa-hag-sf4)" : {
		...
		source : [["AL", "DC-POA"]],
		type : "armor (medium)",
		description : "This breastplate looks like it has been well used. I can doff it as an action.",
	...
	"cast-off chain mail: scavenger's shroud (ccc-des-4-1)" : {
		...
		source : [["AL", "CCC"]],
		type : "armor (heavy)",
		description : "This cleverly crafted cowl and coat combination is made of worn leather covered in dangling chains and hooks, and gives me the appearance of a chain devil (kyton) when I wear it. I can doff it as an action.",
	...
	"cast-off plate (bmg-drw-od-5)" : {
		...
		source : [["AL", "DRW"]],
		type : "armor (heavy)",
		description : "This rusty set of plate armor has a Thayan rune with dried blood in the grooves etched into the inside back of the breastplate. I can doff it as an action.",
		descriptionFull : "This rusty set of plate armor has a Thayan rune with dried blood in the grooves etched into the inside back of the breastplate. You can doff it as an action.",
	...
	"shield of expression (dc-poa-conmar-15)" : {
		...
		source : [["AL", "DC-POA"]],
		type : "shield",
		description : "This shield is made of bright oak which is painted teal. The logo of “The Silver Lining Trading Company” is circling the face of a white goat. As a bonus action while bearing the shield, I can alter the expression of the face.",
	...
	"shield of expression (wbw-dc-conmar-10)" : {
		...
		source : [["AL", "WBW-DC"]],
		type : "shield",
		description : "This shield bears the face of one of the Hopelessly Devoted Knights, whose standard expression is a smirk. As a bonus action while holding it, I can alter the expression of the face.",
	...
	"shield of expression (wbw-dc-dcs-1)" : {
		...
		source : [["AL", "WBW-DC"]],
		type : "shield",
		description : "The face on this shield is Sune, which is also the goddess' holy symbol. As an action while wielding it, I can cause the shield to repeat my words until my next turn ends. When repeated, my words are audible to 300 ft, sounding more confident & attractive than they are. As a bonus action, I can alter the expression of Sune's face.",
	...
	"smoldering studded leather (dc-poa-conmar-8)" : {
		...
		source : [["AL", "DC-POA"]],
		type : "armor (light)",
		description : "Wisps of harmless, odorless smoke rise from this armor while it's worn. The smoke is thick, black, & threatens to choke me. Any time that I act selfishly, a faint deep chuckle can be heard in the distance.",
	...
	"smoldering breastplate: wintergreen guard (dc-poa-legit-sv-01)" : {
		...
		source : [["AL", "DC-POA"]],
		type : "armor (medium)",
		description : "When I'm struck by bludgeoning damage, this armor emits oils that cause a cool numbing sensation. While not particularly effective at its intended purpose, the volatile oils produce a visible and pleasant smelling vapor that wafts from the armor.",
	...
	"half plate of gleaming (ps-dc-element-death-1)" : {
		name : "Half Plate of Gleaming (PS-DC-ELEMENT-DEATH-1)",
		source : [["AL", "PS-DC"]],
		type : "armor (medium)",
		description : "This half plate armour is made of magically enchanted stone slabs without any metal and never gets dirty.",
...
MagicItemsList["al armor (other)"] = {
	...
	"breastplate of fungal spores (fr-dc-ghg-2)" : {
		...
		magicItemTable : "?",
		rarity : "uncommon",
		description : "This breastplate is fashioned from a large mushroom-infested turtle or tortle shell. As a bonus action once per dawn, it emits poisonous spores in a 10-ft radius sphere around me. Each creature in that area must pass a DC 15 CON save or be poisoned until my next turn ends.",
	...
	"breastplate of necrotic resistance: chardalyn (ddal10-5)" : {
		...
		magicItemTable : "H",
		attunement : true,
		description : "This breastplate is made of chardalyn reinforced with hardened wood and boiled leather. While wearing it, I always feel bitterly cold and when also attuned, I have resistance to necrotic damage.",
	...
	"elven chain (ccc-sqc-2-2)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This chain shirt is made of magically hardened sandalwood that smells like incense at all times. I gain a +1 bonus to AC while I wear the chain shirt & am considered proficient even if I lack proficiency with medium armor.",
	...
	"elven chain: armor of the first frost (wbw-dc-aa-ashalon-1)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "The surface of this icy elvan chain is cold to the touch, with tendrils of frost decorating the metal. While wearing it, I have a keener understanding of duty & responsibility. Despite the material, the temperature around me always remains comfortable & I suffer no harm in temps from -20\u00B0F to 120\u00B0F. The armor also gives me +1 AC & I'm proficient even if I lack proficiency with medium armor.",
	...
	"elven chain (wbw-dc-amq-5)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This elven chain shirt is made of interlocking black & silver metal rings. On the back, the rings form an intricate pattern of a portcullis with the letters “TM” on top. It may be the manager's uniform for the “Dungeon of the Smelly Doom”. While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain: astral (wbw-dc-conmar-12)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This elven chain has a rare design & will make heads turn. The chain weaving is exquisite, delicate and must have been created by some machine-powered process. The trim is adorned with unidentifiable runic letters. While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain (wbw-dc-php-spammy-1)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This chain shirt was crafted inside a fey domain. It reacts to my emotions and personality, changing colors based on my mood and style. If the armor gets hit, it plays a musical chime on impact. While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain (wbw-dc-rook-2-1)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "Made of interlocking amorywood rings as strong as mithral, this chain shirt is of obvious elven design & glows faintly when goblinoids are within 120 ft. While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain (wbw-dc-taz-1)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "Threads of yarn spun from the golden fleece are entwined with the links of this chain shirt, giving it a look of lustrous gold. While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain (wbw-dc-ten-3)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor. I also suffer no harm in temperatures from -20\u00B0F to 120\u00B0F.",
	...
	"elven chain: tehettan's protection (wbw-dc-tmp-2)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "The interlocking rings of Tehettan's Protection are tightly woven vines that were magically grown together. Once in a while a leaf sprouts from the chain. While wearing it, I gain +1 AC & am proficient even if I lack proficiency with medium armor.",
	...
	"elven chain: sky's armor (wbw-dc-zodiac-12)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "Crafted by a master of the Summer Court, this metal armor glimmers gold & sky blue. Etched into the chain in elvish and orcish is: “It's a victory when the weapons fall silent and people speak up.” While wearing this chain, I gain +1 AC & am proficient even if I lack proficiency with medium armor. It also squeals a warning, granting +2 initiative unless incapacitated.",
	...
	"glamoured studded leather: cinderella's wedding corset (wbw-dc-conmar-15)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This magical armor grants +1 to AC. It's natural state is a white corset decorated with lace & rhinestones. Speak the command word as a bonus action to make it look like normal clothing or another armor type. I decide the appearance, but the armor retains its normal bulk. The illusion lasts until I use this property again or remove the armor.",
	...
	"mariner's studded leather (ddal-drw9)" : {
		...
		rarity : "uncommon",
		magicItemTable : "B",
		description : "Made from tough, flexible shark leather, this armor is reinforced with close-set coral spikes. While wearing it, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I rise 60 ft toward the surface. The armor is decorated with fish & shell motifs.",
	...
	"mariner's breastplate (ccc-aether-1-2)" : {
		...
		rarity : "uncommon",
		magicItemTable : "B",
		description : "The number “12101993” is etched into the inside of this green metallic breastplate along with a single word in Abyssal: “Doomed”. While wearing this armor, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I rise 60 ft toward the surface. The armor is decorated with fish & shell motifs.",
	...
	"mariner's breastplate (ccc-mmt1-2)" : {
		...
		rarity : "uncommon",
		magicItemTable : "B",
		description : "While wearing this breastplate, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I rise 60 ft toward the surface. The armor is decorated with fish & shell motifs as well as the holy symbol of Umberlee.",
	...
	"mariner's scale mail (alsrs11-a)" : {
		...
		rarity : "uncommon",
		magicItemTable : "B",
		description : "Constructed of overlapping flat smooth river stones, this set of scale mail is surprisingly light & mobile. While wearing it, I need half the water normally required to stave off exhaustion & have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I rise 60 ft toward the surface. The armor is decorated with fish & shell motifs.",
	...
	"plate armor of etherealness (ddal8-16)" : {
		...
		rarity : "legendary",
		magicItemTable : "I",
		description : "This armor has a holy symbol of Shar forged into the breast & reflects light poorly. While I wear it, I can speak & understand Qualith without rolling any checks or saves to avoid short-term madness. Once per dawn, I can speak armor's command word as an action to gain the effect of the Etherealness spell, which lasts for 10 minutes or until I remove the armor/speak the command word as action again.",
	...
	"red dragon scale mail (ddep5-1)" : {
		...
		description : "This beautiful suit of scale mail is made from red dragon hide. Gold decorates the pauldrons & greaves, & the helm is crafted in the shape of a snarling dragon complete with horns. This armor gives +1 to AC, adv. on saves against dragons' frightful presence & breath weapons, & resistance to fire dmg. As an action once/dawn, I can discern the distance & direction to closest red dragon in 30 miles.",
	...
	"red dragon scale mail (ddal9-15)" : {
		...
		description : "This was once the armor of Carmine, an orcish paladin of the Bloody Hooves. She didn't survive into the final caverns to have her soul entombed to wait for Zariel's return. This red dragon scale mail gives +1 to AC, adv. on saves against dragons' frightful presence & breath weapons, & resistance to fire dmg. As an action once per dawn, I can discern the distance & direction to closest red dragon in 30 miles.",
	...
	"scale mail of psychic resistance: resin (ccc-tri-21 yul1-6)" : {
		...
		magicItemTable : "H",
		attunement : true,
		description : "This armor is made from a hardened resin similar to amber. While worn, I have resistance to psychic damage. After its psychic resistance is used, I'm wracked with terrible nightmares of unfathomable creatures that evening.",
...
MagicItemsList["al shields"] = {
	...
	"+1 shield (ddex3-5)" : {
		...
		rarity : "uncommon",
		magicItemTable : "F",
		description : "This shield is fashioned from the hide of an umber hulk. It bears the oak leaf symbol commonly associated with the nature deity Silvanus. While holding this shield, I have a +1 bonus to AC in addition to the shield's normal AC bonus.",
	...
	"+1 shield of the moon (ccc-tarot1-2)" : {
		...
		rarity : "uncommon",
		magicItemTable : "F",
		description : "This shield is painted to resemble the moon. While equipped, I can use a bonus action to make it glow with a soft moonlight in a 20-ft radius. No colors can be discerned in the moonlight so all objects show up as shades of grey. While holding this shield, I have a +1 bonus to AC in addition to its normal AC bonus.",
	...
	"+1 shield of the salty griffon (ccc-tri-19 dead1-1)" : {
		...
		rarity : "uncommon",
		magicItemTable : "F",
		description : "This shield is crafted from a giant, polished oyster shell. While holding this shield, I have a +1 bonus to AC in addition to the shield's normal AC bonus.",
	...
	"+2 shield: yata mirror (ccc-anime1-2)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "The Yata Mirror is an ancient relic created by those who created the Guardians. This shield is endowed with magic that changes its characteristics to absorb damage from attacks. While wielding the polished silver disc, it becomes translucent and grants a +2 bonus to my AC in addition to the shield's normal AC bonus.",
	...
	"+3 shield: miltiades' shield (ccc-bmg-13 phlan1-1)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "H",
		description : "This shield is decorated with symbols of service & fealty. It encourages service to others empathetically & whenever I consider performing a selfish act, it enhances pangs of conscience. While holding this shield, I gain a +3 bonus to AC.",
	...
	"+3 shield: aegis of the raven queen (ccc-bwm-3)" : {
		...
		source : [["AL", "CCC"]],
		magicItemTable : "H",
		description : "This shield appears as a shroud of shadow w/ the symbol of the Raven Queen glowing in dim red light. While holding it, nonmagical flames w/i 30 ft are extinguished as the shadow lashes out at the flame. The shield encourages me to lack pity for those who suffer & die, for death is the natural end. I gain a +3 bonus to AC in addition to the shield's normal AC bonus.",
	...
	"animated shield (ddep5-2)" : {  // contains contributions by Larry Hoy
		...
		rarity : "very rare",
		magicItemTable : "H",
		description : "The enormous shield is etched with images of Annam the All-Father holding court over the gods of the “lesser races”. While attuned to the shield, I cannot tell lies. As a bonus action, speak the command word to animate shield for 1 minute, until I use another bonus action (returns to hand), or until I'm incapacitated/die (falls to ground). The shield leaps into the air, hovering in my space to protect me.",
	...
	"animated shield (ddep8-3)" : {  // contains contributions by Larry Hoy
		...
		rarity : "very rare",
		magicItemTable : "H",
		description : "This shield appears as the head of a large beer keg, ringed by a rusty iron band. Whenever the shield is struck by a blow, I hear a chorus of cheering dwarven voices. As a bonus action, I can speak the command word to animate shield for 1 minute, until I use another bonus action (returns to hand), or until I'm incapacitated/die (falls to ground). The shield leaps into the air, hovering in my space to protect me.",
	...
	"arrow-catching shield (ccc-bmg-moon13-3)" : { // contains contributions by Larry Hoy
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This large round wooden shield is dark brown, with a black iron rim & boss. It's decorated with two entwined red serpents, each holding a bundle of broken arrows in their mouths. The shield is surprisingly light & floats on water. While wielding it, I gain an additional +2 bonus to AC against ranged attacks (not calculated in 1st page AC). When an attacker makes a ranged atk against a target in 5 ft of me, I can become the target of the atk as a reaction.",
	...
	"arrow-catching shield (ccc-glip-2-1)" : { // contains contributions by Larry Hoy
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This bronze-inlaid shield bears the marching dragon symbol of the Kroth Magg hobgoblin clan. While wielding it, I gain an additional +2 bonus to AC against ranged attacks (not calculated in 1st page AC). When an attacker makes a ranged atk against a target in 5 ft of me, I can become the target of the atk as a reaction.",
	...
	"arrow-catching shield (ddal9-8)" : { // contains contributions by Larry Hoy
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This round, metal shield is decorated w/ braids of hair from the unicorn Zhalruban & emblazoned w/ the insignia of the Hellriders. While wielding it, I gain an additional +2 bonus to AC against ranged attacks (not calculated in 1st page AC). If an attacker makes a ranged atk against a target in 5 ft of me, I can become the target of the atk as a reaction. When I do this, the shield pulses with magic.",
	...
	"sapphire buckler (sj-dc-inas-5)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "This shield was made from the scale of a sapphire dragon. While wielded, I have resistance to psychic and thunder dmg. When I take dmg from a creature in 5 ft, I can deal 2d6 thunder dmg as a reaction. Once per dawn as an action, I know the direction of all aberrations within 1 mile until my next turn ends. I also suffer no harm in temperatures from -20\u00B0F to 120\u00B0F.",
		descriptionFull : "This crystalline blue shield is fashioned from a sapphire dragon's scale and is created to aid in rooting out the influence of Aberrations. While wielding the shield, you have resistance to psychic and thunder damage. Also, when you take damage from a creature that is within 5 feet of you, you can use your reaction to deal 2d6 thunder damage to that creature."+
		"\n   As an action, you can use the shield to help you locate Aberrations until the end of your next turn. If any Aberrations are within 1 mile of you, the shield emits a low humming tone for a moment, and you know the direction of all Aberrations within that range. Once this property is used, it can't be used again until the next dawn."+
		"\n   " + toUni("Temperate") + ". The bearer suffers no harm in temperatures as cold as –20 degrees Fahrenheit or as warm as 120 degrees Fahrenheit.",
		weight : 6,
	...
	"sentinel shield (ccc-bmg-moon11-1)" : {
		...
		description: "This shield is emblazoned with a symbol of an eye. Whenever it grants adv. on a roll, the eye on the front squints & says “hmmmm” in a deep gravelly voice that is audible to within 30 ft. While holding this shield, I have adv. on initiative rolls & Wisdom (Perception) checks.",
	...
	"sentinel shield (ccc-wwc-7)" : {
		...
		advantages : [["Initiative", true], ["Perception", true]],
		vision : [["Adv. on Perception checks", 0]],
		description: "The shield is emblazoned with a flaming sword, the holy symbol of the warrior god, Tempus. While holding this shield, I have advantage on initiative rolls & Wisdom (Perception) checks.",
	...
	"sentinel shield (ddal-cgb)" : {
		...
		advantages : [["Initiative", true], ["Perception", true]],
		vision : [["Adv. on Perception checks", 0]],
		description: "This shield is emblazoned with a symbol of an eye & glows faintly when a giant is within 120 ft. While holding the shield, I have advantage on initiative rolls & Wisdom (Perception) checks.",
	...
	"sentinel shield (ddex2-12)" : {
		...
		advantages : [["Initiative", true], ["Perception", true]],
		vision : [["Adv. on Perception checks", 0]],
		description: "This oblong shield has an obvious eye motif with several eyes on its surface that occasionally blink. While holding this shield, I have adv. on initiative rolls & Wisdom (Perception) checks.",
	...
	"shield of missile attraction: ward of chimali (rmh-10)" : {
		...
		rarity : "rare",
		magicItemTable : "G",
		description : "This shield is fashioned from a sheet of magically hardened gold set with unpolished chunks of amber & a fist-sized ruby. While holding it, I have resistance to dmg from ranged weapon atks. Once attuned, I'm cursed & whenever a ranged weapon atk is made against a target within 10 ft of me, it targets me instead.",
	...
	"spellguard shield (ccc-rozk1-3)" : {
		...
		rarity : "very rare",
		magicItemTable : "H",
		description : "This steel shield is embossed with a longsword wrapped in thorny vines that ends in roses in full bloom. The enamel coloring the roses is still vibrant. While holding this shield, I have advantage on saving throws against spells and other magical effects, and spell attacks have disadvantage against me.",
		attunement : true,
		weight : 6,
		shieldAdd : "Spellguard Shield",
		savetxt : { adv_vs : ["spells", "magical effects"] }
	...
	"spellguard shield (ddep7-2)" : {
		...
		rarity : "very rare",
		magicItemTable : "H",
		description : "This shield is fashioned from a single piece of flawless crystal with straps of supple leather. While holding this shield, I have advantage on saving throws against spells and other magical effects, and spell attacks have disadvantage against me.",
		attunement : true,
		weight : 6,
		shieldAdd : "Spellguard Shield",
		savetxt : { adv_vs : ["spells", "magical effects"] }
