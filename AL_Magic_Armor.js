...
MagicItemsList["al armor +1, +2, +3"] = {
	...
	"+1 leather (ddep7-1)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This sealskin suit is embroidered with octopi that squirm magically when exposed to the air. If worn underwater, I gain advantage on checks made to escape grapples. The suit also grants a +1 bonus to AC while worn.",
	...
	"+1 leather: mummy wraps (rv-dc-gc15-4)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This roll of thick black-and-gold mummy wraps was kept in the Temple of Ousa to repair pharaoh's wraps. When unrolled and worn, I gain a +1 bonus to AC.",
	...
	"+1 studded leather (fr-dc-aeg-7)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This armor grants a +1 bonus to AC while worn. It also whispers warning, giving +2 Initiative if I'm not Incapacitated.",
	...
	"+1 breastplate (sj-dc-asi-3)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This armor was recovered from the fallen githyanki Vaa'len. The intricately forged dark metal accentuates my musculature and bands of inlayed silver highlight the magical patterns. This breastplate grants a +1 bonus to AC while worn and warns me, giving +2 Initiative if I'm not Incapacitated.",
	...
	"+1 breastplate: sha'sal khou (sj-dc-rfjk-2-1)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This breastplate is simply but strongly made and is engraved with a crest upon the left breast, identifying me as an ally of the Sha'sal Khou. While worn, the armor grants a +1 bonus to AC and lets me speak Gith.",
	...
	"+1 half plate (ddep4)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This black enameled armor has a splash of green paint across the chest. No amount of cleaning will remove it; even magical attempts prove useless. Any creature familiar with the Tears of Virulence will likely treat the wearer with suspicion. I have a +1 bonus to AC while wearing this armor.",
	...
	"+1 half plate: warforged chest piece (rv-dc-php-1313-1)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This half plate fell off one of the warforged peace corps protecting Metrol city. The upper left bears the symbol of an iron bull with cogs and gears that glows near danger. While worn, it grants a +1 bonus to AC and +2 bonus to Initiative as long as I'm not Incapacitated.",
	...
	"+1 half plate: mazatil's remorse (sj-dc-stratcon-1)" : {
		...
		rarity : "rare",
		allowDuplicates : true,
		description : "This half plate is made from topaz dragon scales, though few metallic or gem dragons would look down on me for wearing it. As a side effect of the armor's magic, it shines a beam of harmless purple light whenever deflecting an attack. While worn, it grants a +1 bonus to AC.",
	...
	"+2 plate (trading post)" : {
		...
		descriptionFull : "Every inch of this plate armor is covered with holy symbols and prayers to Helm, including the leather straps and inner pieces of metal not visible to the eye. The armor grants a +2 bonus to AC while worn (Custom flavor from the June 2024 VDDW Trading Post).",
	...
	"+3 studded leather (ps-dc-ss)" : {
		...
		rarity : "legendary",
		allowDuplicates : true,
		description : "This black studded leather armor is made from the hide of a Far Realm monstrosity and grants a +3 bonus to AC while worn. The hide's exposure to the Far Realm protects me from harm in extreme temps past 0\u00B0F and 100\u00B0F. If the armor is flipped inside out, a game of tic-tac-toe using the letters “M” and “E” is visible. ",
	...
	"+3 plate (ps-dc-aug-1)" : {
		...
		rarity : "legendary",
		allowDuplicates : true,
		description : "This plate armor was recovered from the ursine archons that guard the gate to Mount Celestia and still smells of bear. It grants a +3 bonus to AC while worn and warns me, giving +2 Initiative when I'm not Incapacitated.",
	...
	"+3 plate (ps-dc-element-death-1)" : {
		...
		rarity : "legendary",
		allowDuplicates : true,
		description : "This plate armour is made of magically enchanted stone slabs without any metal. You have a +3 bonus to AC while wearing the armor.",
...
MagicItemsList["al armor (other)"] = {
	...
	"efreeti chain (ddal7-15)" : {
		...
		rarity : "legendary",
		description : "The efreeti Prince Rashidi al-Zahar ibn Rath transmogrified an efreeti sultana into this delicate crimson armor. While worn, I always feels a slight draft & sometimes find it hard to stay focused on a task. I gain a +3 bonus to AC, am immune to Fire, and can understand and speak Primordial. I can also stand on & walk across molten rock as if solid ground.",
	...
	"elven chain (ccc-bmg-36 elmw2-3)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "This weird silvery-purple armor is as thin & light as linen. It has a muted wave symbol of Istishia, the neutral god known as the Water Lord, patterned into the links & must have once belonged to a sea elf. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (ccc-sqc-2-2)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "This armor is made of magically hardened sandalwood that smells like incense at all times. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain: armor of the first frost (wbw-dc-aa-ashalon-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "The surface of this icy armor is cold to the touch, with tendrils of frost decorating the metal. While worn, I have a keener understanding of duty & responsibility. Despite the material, the temperature around me always remains comfortable & I'm unharmed by extreme temps past 0\u00B0F & 100\u00B0F. I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-amq-5)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "This armor is made of interlocking black & silver metal rings. On the back, the rings form an intricate pattern of a portcullis with the letters “TM” on top. It may be the manager's uniform for the “Dungeon of the Smelly Doom”. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain: astral (wbw-dc-conmar-12)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "This armor has a rare design & will make heads turn. The chain weaving is exquisite, delicate and must have been created by some machine-powered process. The trim is adorned with unidentifiable runic letters. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain: guardian (wbw-dc-ggs-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "The interlocking rings of this armor form a delicate black & white spider web. Fine script stenciled around the neck repeats the phrase “Granny has little patience for rudeness” in Elvish. When danger is imminent, it whispers “mind your manners & be polite” & I feel like dozens of tiny spiders are crawling across my body. The warning grants +2 Initiative unless Incapacitated. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain: loud (wbw-dc-ggs-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "The interlocking rings of this armor form a delicate black & white spider web. Fine script stenciled around the neck repeats the phrase “Granny has little patience for rudeness” in Elvish. When I'm hit by an atk, I feel like dozens of tiny spiders are crawling across my body from the spider web. There's also a discordant violin sound & Granny Greataxe's voice saying “How rude!” at normal speaking volume. I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-php-spammy-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "This armor was crafted inside a fey domain. It reacts to my emotions and personality, changing colors based on my mood and style. If hit, the armor plays a musical chime on impact. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-rook-2-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "Made of interlocking amorywood rings as strong as mithral, this armor is of obvious elven design & glows faintly when goblinoids are within 120 ft. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-taz-1)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "Threads of yarn spun from the golden fleece are entwined with the links of this armor, giving it a look of lustrous gold. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-ten-3)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "While wearing this armor, I gain a +1 bonus to AC & am considered proficient even if I lack training. I'm unharmed by extreme temps past 0\u00B0F & 100\u00B0F",
	...
	"elven chain: tehettan's protection (wbw-dc-tmp-2)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "The interlocking rings of Tehettan's Protection are tightly woven vines that were magically grown together. Once in a while a leaf sprouts from the armor. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain (wbw-dc-zep-t2s5)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "Instead of metal, this armor appears to be an orange cloth vest embroidered with “Zep Chimelong Kingdom” that floats on water and other liquids. The inside tag reads, “Compliments of Princess Petunia”. While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training.",
	...
	"elven chain: sky's armor (wbw-dc-zodiac-12)" : {
		...
		type : "armor (chain mail or chain shirt)",
		rarity : "rare",
		description : "Crafted by a master of the Summer Court, this metal armor glimmers gold & sky blue. Etched in Elvish and Orcish is: “It's a victory when the weapons fall silent and people speak up.” While worn, I gain a +1 bonus to AC & am considered proficient even if I lack training. It also squeals warnings, granting +2 Initiative unless Incapacitated.",
	...
	"glamoured studded leather (ddal4-9)" : {
		...
		rarity : "rare",
		description : "This armor is tight & immodestly cut. While worn, I gain +1 AC & as a bonus action, I can make it look like normal clothing or another armor type of the finest quality. I decide appearance, but the armor retains its bulk. No matter what form the armor takes, I draw the eye. The illusion lasts until I use this property again or doff the armor.",
		descriptionLong : "This studded leather armor is tight and immodestly cut. While wearing it, I gain a +1 bonus to AC. As a bonus action, I can cause the armor to look like normal clothing or another armor type. I decide its appearance, but the armor retains normal bulk. Any illusion created by this item appears to be of the finest quality. No matter what form it takes, my appearance draws the eye. The illusion lasts until I use this property again or doff the armor.",
	...
	"glamoured studded leather (ddal8-11)" : {
		...
		type : "armor (studded leather)",
		rarity : "rare",
		description : "This studded armor is made of salmon leather that has been dyed midnight black. While worn, I can't become wet unless fully immersed in a liquid & gain a +1 bonus to AC. As a bonus action, I can make the armor to look like normal clothing or another armor type. I decide appearance, but the armor retains its bulk. The illusion lasts until I use this property again or doff the armor.",
	...
	"glamoured studded leather (ddal9-6)" : {
		...
		type : "armor (studded leather)",
		rarity : "rare",
		description : "Made from tough yet flexible giant abyssal crocodile hide leather & studded with what look to be teeth, this armor grants me +1 AC. As a bonus action, I can make the armor to look like normal clothing or another armor type. I decide appearance, but the armor retains its bulk. The illusion lasts until I use this property again or doff the armor.",
	...
	"glamoured studded leather: cinderella's wedding corset (wbw-dc-conmar-15)" : {
		...
		type : "armor (studded leather)",
		rarity : "rare",
		description : "This armor's natural state is a white corset decorated with lace & rhinestones. While worn, I gain +1 AC & can use a bonus action to make it look like normal clothing or other armor type. I decide the appearance, but the armor retains its bulk. The illusion lasts until I use this property again or doff the armor.",
	...
	"hide armor of fungal spores (po-bmg-int-2)" : {
		...
		type : "armor (breastplate)",
		rarity : "uncommon",
		description : "This boar hide armor has been soaked in an herbal solution so spores from local Gentlebreeze mushrooms grow across its surface. Some of the spores are orange-red and have potent properties. As a bonus action once per dawn, the armor emits poisonous spores in a 10-ft radius sphere around me. Each creature in that area must pass a DC 15 CON save or be poisoned until my next turn ends.",
	...
	"mariner's studded leather (ddal-drw9)" : {
		...
		type : "armor (breastplate)",
		rarity : "uncommon",
		description : "Made from tough, flexible shark leather, this armor is reinforced with close-set coral spikes and decorated with fish & shell motifs. While worn, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I gain 1d4 HP.",
		descriptionFull : "Made from tough, flexible shark leather, this armor is reinforced with close-set coral spikes.\n   While wearing this armor, you have a swimming speed equal to your walking speed. In addition, whenever you start your turn underwater with 0 hit points, I immediately regain 1d4 hit points. The armor is decorated with fish and shell motifs.",
		allowDuplicates : true,
	...
	"mariner's breastplate (ccc-aether-1-2)" : {
		...
		type : "armor (breastplate)",
		rarity : "uncommon",
		description : "The number “12101993” is etched into the inside of this green metallic breastplate along with a single word in Abyssal: “Doomed”. It's decorated with fish & shell motifs. While worn, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I gain 1d4 HP.",
	...
	"mariner's breastplate (ccc-mmt1-2)" : {
		...
		type : "armor (breastplate)",
		rarity : "uncommon",
		description : "While wearing this armor, I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I gain 1d4 HP. The armor is decorated with fish & shell motifs as well as the holy symbol of Umberlee.",
	...
	"mariner's scale mail (al:sa-11a)" : {
		...
		rarity : "uncommon",
		description : "Constructed of overlapping flat smooth river stones, this set of scale mail is surprisingly light & mobile. While wearing it, I need half the water normally required to stave off exhaustion & I have a swimming speed equal to my walking speed. In addition, whenever I start my turn underwater with 0 hp, I gain 1d4 HP.",
	...
	"plate armor of etherealness (ddal8-16)" : {
		...
		type : "armor (plate)",
		rarity : "legendary",
		description : "This armor has a holy symbol of Shar forged into the breastplate & reflects light poorly. While worn, I can speak Qualith without rolling to avoid short-term madness. Once per dawn, I can say command word as a Magic action to gain the effect of Etherealness, which lasts for 10 min or until I remove the armor/repeat the action.",
	...
	"red dragon scale mail (ddep5-1)" : {
		...
		description : "This beautiful suit of scale mail is made from red dragon hide. Gold decorates the pauldrons & greaves, & the helm is crafted in the shape of a snarling horned dragon. The armor gives +1 to AC, adv. on saves against dragon breath weapons & resistance to Fire. As a Magic action once per dawn, I can discern the distance & direction to closest red dragon in 30 miles.",
	...
	"red dragon scale mail (ddal9-15)" : {
		...
		description : "This was once the armor of Carmine, an orcish paladin of the Bloody Hooves. She didn't survive into the final caverns to have her soul entombed for Zariel's return. The armor gives +1 to AC, adv. on saves against dragon breath weapons & resistance to Fire. As a Magic action once per dawn, I can discern the distance & direction to closest red dragon in 30 miles.",
	...
	"scale mail of psychic resistance: resin (ccc-tri-21 yul1-6)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This armor is made from a hardened resin similar to amber. While worn, I have resistance to Psychic damage. After the resistance is used, I'm wracked with terrible nightmares of unfathomable creatures that evening.",
	...
	"studded leather of fire resistance (ddal0-11c)" : {
		...
		rarity : "rare",
		attunement : true,
		description : "This studded leather armor is reinforced with rivets made of unmeltable ice, and steams faintly when I'm hit with fire attacks. While worn, I have resistance to Fire damage.",
...
MagicItemsList["al shields"] = {
	...
	"+1 shield (ddex3-5)" : {
		...
		source : [["AL", "S3"]],
		rarity : "uncommon",
		description : "This shield is fashioned from the hide of an umber hulk. It bears the oak leaf symbol commonly associated with the nature deity Silvanus. While held, I have a +1 bonus to AC in addition to the shield's normal AC bonus.",
	...
	"+1 shield of the moon (ccc-tarot1-2)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "uncommon",
		description : "This shield is painted to resemble the moon. I can use a bonus action to make it glow with a soft moonlight in a 20-ft radius. No colors can be discerned in the moonlight so all objects appear as shades of grey. While held, I have a +1 bonus to AC.",
	...
	"+1 shield of the salty griffon (ccc-tri-19 dead1-1)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "uncommon",
		description : "This shield is crafted from a giant, polished oyster shell. While held, I have a +1 bonus to AC in addition to the normal AC bonus.",
	...
	"+2 shield: wall of teeth (ddex2-14)" : {
		...
		source : [["AL", "S2"]],
		rarity : "rare",
		description : "This shield is fashioned of dull black steel and festooned with hundreds upon hundreds of human teeth. Whenever I'm presented with an opportunity to act in a selfish or malevolent way, it heightens the urge. While held, I have a +2 bonus to AC.",
	...
	"+2 shield: yata mirror (ccc-anime1-2)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "rare",
		description : "This polished silver disc is an ancient relic created by those who created the Guardians. This shield is endowed with magic that changes its characteristics to absorb damage from attacks. While wielded, it becomes translucent and grants a +2 bonus to AC.",
	...
	"+3 shield: miltiades' shield (ccc-bmg-13 phlan1-1)" : {
		...
		rarity : "very rare",
		source : [["AL", "CCC"]],
		description : "This shield is decorated with symbols of service & fealty. It encourages service to others empathetically & whenever I consider performing a selfish act, it enhances pangs of conscience. While held, I gain a +3 bonus to AC.",
	...
	"+3 shield: aegis of the raven queen (ccc-bwm-3)" : {
		...
		rarity : "very rare",
		source : [["AL", "CCC"]],
		description : "This shield is a shroud of shadow with the symbol of the Raven Queen glowing in dim red light. While held, nonmagical flames in 30 ft are extinguished as the shadow lashes out at the flame. The shield encourages a lack of pity for those who suffer & die; death is the natural end. I gain a +3 bonus to AC.",
	...
	"animated shield (ddep5-2)" : {  // contains contributions by Larry Hoy
		...
		source : [["AL", "S5"]],
		rarity : "very rare",
		description : "The enormous shield is etched with images of Annam the All-Father holding court over the gods of the “lesser races”. While attuned to the shield, I can't tell lies. As a bonus action, I can animate the shield for 1 min. It leaps into the air, hovering in my space to protect me as if wielded until I use another bonus action (returns to hand), or I'm Incapacitated/die (falls to ground).",
	...
	"arrow-catching shield (ccc-bmg-moon13-3)" : { // contains contributions by Larry Hoy
		...
		source : [["AL", "CCC"]],
		rarity : "rare",
		description : "This large round wooden shield is dark brown, with a black iron rim & boss. It's decorated with two entwined red serpents, each holding a bundle of broken arrows in their mouths. The shield is surprisingly light & floats on water. While wielded, I gain +2 AC against ranged atks (not in 1st page AC). When a ranged atk is made against a target in 5ft of me, I can become the target as a reaction.",
	...
	"arrow-catching shield (ccc-glip-2-1)" : { // contains contributions by Larry Hoy
		...
		source : [["AL", "CCC"]],
		rarity : "rare",
		description : "This bronze-inlaid shield bears the marching dragon symbol of the Kroth Magg hobgoblin clan. While wielded, I gain a +2 bonus to AC against ranged atks (not in 1st page AC). When a ranged atk is made against a target in 5ft of me, I can become the target as a reaction.",
	...
	"arrow-catching shield (ddal9-8)" : { // contains contributions by Larry Hoy
		...
		source : [["AL", "S9"]],
		rarity : "rare",
		description : "This round, metal shield is decorated with braids of hair from the unicorn Zhalruban & emblazoned with the insignia of the Hellriders. While wielded, I gain +2 AC against ranged atks (not in 1st page AC). When a ranged atk is made against a target in 5ft of me, I can become the target as a reaction.",
	...
	"arrow-catching shield (ddal-drwep3)" : { // contains contributions by Larry Hoy
		...
		source : [["AL", "DRW"]],
		rarity : "rare",
		description : "This gold-trimmed red shield is emblazoned with Candlekeep's coat of arms. While wielded, I gain a +2 bonus to AC against ranged atks (not in 1st page AC). When a ranged atk is made against a target in 5ft of me, I can become the target as a reaction.",
	...
	"sapphire buckler (ddal-drw19)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "One of Amaranthraxine's draconic allies on Abeir gifted a scale for this crystalline blue shield. While wielded, I have resistance to psychic & thunder dmg. When I take dmg from a creature in 5 ft, I can deal 2d6 thunder dmg as a reaction. Once per dawn as an action, I know the direction of all aberrations within 1 mile until my next turn ends.",
	...
	"sapphire buckler (sj-dc-inas-5)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "This shield was made from the scale of a sapphire dragon. While wielded, I have resistance to psychic and thunder dmg. When I take dmg from a creature in 5 ft, I can deal 2d6 thunder dmg as a reaction. Once per dawn as an action, I know the direction of all aberrations within 1 mile until my next turn ends. I'm also unharmed by extreme temps past 0\u00B0F & 100\u00B0F",
		descriptionFull : "This crystalline blue shield is fashioned from a sapphire dragon's scale and is created to aid in rooting out the influence of Aberrations. While wielding the shield, you have resistance to psychic and thunder damage. Also, when you take damage from a creature that is within 5 feet of you, you can use your reaction to deal 2d6 thunder damage to that creature."+
		"\n   As an action, you can use the shield to help you locate Aberrations until the end of your next turn. If any Aberrations are within 1 mile of you, the shield emits a low humming tone for a moment, and you know the direction of all Aberrations within that range. Once this property is used, it can't be used again until the next dawn."+
		"\n   " + toUni("Temperate") + ". You are unharmed by temperatures of 0 degrees Fahrenheit or lower, and 100 degrees Fahrenheit or higher.",
		weight : 6,
	...
	"sapphire buckler (sj-dc-mist-2)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "This shield was made from the scale of a sapphire dragon and has wires attached to it from when it was used as part of the failsafe system of the FARM. I can attune in 1 min and while wielded, I have resistance to psychic and thunder dmg. When I take dmg from a creature in 5 ft, I can deal 2d6 thunder dmg as a reaction. Once per dawn as an action, I know the direction of all aberrations within 1 mile until my next turn ends.",
	...
	"sapphire buckler: bee's knees (sj-dc-triden-bz)" : {
		...
		rarity : "very rare",
		attunement : true,
		description : "A modular panel stamped with the tiny bee logo of Honeybell Habitats, this hexagonal shield buzzes instantly to life whenever its security protocol is triggered. I can attune in 1 min and while wielded, I have resistance to psychic and thunder dmg. When I take dmg from a creature in 5 ft, I can deal 2d6 thunder dmg as a reaction. Once per dawn as an action, I know the direction of all aberrations within 1 mile until my next turn ends.",
	...
	"sentinel shield (ccc-bmg-moon11-1)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "uncommon",
		description: "This shield is emblazoned with a symbol of an eye. Whenever it grants advantage, the eye on the front squints & says “hmmmm” in a deep gravelly voice audible for 30 ft. While held, I have advantage on Initiative and Wisdom (Perception) checks.",
	...
	"sentinel shield (ccc-wwc-7)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "uncommon",
		description: "The shield is emblazoned with a flaming sword, the holy symbol of the warrior god, Tempus. While held, I have advantage on Initiative and Wisdom (Perception) checks.",
	...
	"sentinel shield (ddal-cgb)" : {
		...
		source : [["AL", "CGB"]],
		rarity : "uncommon",
		description: "This shield is emblazoned with a symbol of a large eye & glows faintly when a Giant is within 120 ft. While held, I have advantage on Initiative and Wisdom (Perception) checks.",
	...
	"shield of missile attraction: ward of chimali (rmh-10)" : {
		...
		source : [["AL:R",10]],
		rarity : "rare",
		description : "This shield is fashioned from a sheet of magically hardened gold set with unpolished chunks of amber & a fist-sized ruby. While held, I resist dmg from ranged weapons. Once attuned, I'm cursed. Whenever a ranged weapon atk target someone within 10 ft, it targets me instead.",
	...
	"spellguard shield (ccc-rozk1-3)" : {
		...
		source : [["AL", "CCC"]],
		rarity : "very rare",
		description : "This steel shield is embossed with a longsword wrapped in thorny vines that ends in roses in full bloom. The enamel coloring the roses is still vibrant. While held, I have advantage on saves against spells and magical effects, and spell attacks have disadvantage against me.",
