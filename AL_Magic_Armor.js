...
MagicItemsList["al adamantine/mithral armor"] = {
	...
	"mithral scale mail (ccc-odfc2-1)" : {
		...
		armorAdd : { select : "Mithral Scale Mail", options : ["Mithral Scale Mail"], noStealthDis : /mithral/i},
	},
	"mithral scale mail: hulk-buster armor (dc-poa-tdg1-7)" : {
		...
		armorAdd : { select : "Hulk-Buster Mithral Scale Mail", options : ["Hulk-Buster Mithral Scale Mail"], noStealthDis : /mithral/i},
	},
	...
	"mithral half plate (ccc-glip-1-3)" : {
		...
		armorAdd : { select : "Mithral Half Plate", options : ["Mithral Half Plate"], noStealthDis : /mithral/i},
	},
	"mithral chain mail (ccc-saf2-1)" : {
		...
		armorAdd : { select : "Mithral Chain Mail", options : ["Mithral Chain Mail"], noStealthDis : /mithral/i},
	},
	"mithral splint (ccc-des-2-2)" : {
		...
		armorAdd : { select : "Mithral Splint", options : ["Mithral Splint"], noStealthDis : /mithral/i},
	},
	"mithral splint: armor of insults (ccc-gsp-ooze1-1)" : {
		...
		armorAdd : { select : "Armor of Insults, Mithral Splint", options : ["Armor of Insults, Mithral Splint"], noStealthDis : /mithral/i},
	},
	...
	"mithral plate (ddhc-mord-1)" : {
		...
		armorAdd : { select : "Mithral Plate", options : ["Mithral Plate"], noStealthDis : /mithral/i},
	},
}
...
MagicItemsList["al armor (common)"] = {
	...
	"cast-off plate (fr-dc-scrog-ghh)" : {
		name : "Cast-Off Plate (FR-DC-SCROG-GHH)",
		source : [["AL", "FR-DC"]],
		type : "armor (heavy)",
		description : "This battered suit of armor has clearly seen better days. The metal is dented and scratched, the straps look hastily repaired, and several plates bear hairline cracks that suggest the armor might collapse at any moment. Despite its worn appearance, the armor remains surprisingly sturdy. It can be doffed as a Magic action.",
		descriptionFull : "This battered suit of plate armor has clearly seen better days. The metal is dented and scratched, the straps look hastily repaired, and several plates bear hairline cracks that suggest the armor might collapse at any moment. Despite its worn appearance, the armor remains surprisingly sturdy.\n   " + toUni("Fragile") + ". The item crumbles, frays, chips, or cracks slightly when wielded, worn, or activated. This quirk has no effect on its properties.\n   You can doff this armor as a Magic action.",
		armorAdd : { select : "Cast-Off Plate", options : ["Cast-Off Plate"] },
		action : [["action", "Cast-Off Plate"]]
	},
	...
	"cast-off plate: hyperion's shell (sj-dc-php-fln3-eos)" : {
		name : "Hyperion's Shell, Cast-Off Plate (PHP-FLN3-EOS)",
		source : [["AL", "SJ-DC"]],
		type : "armor (heavy)",
		description : "This plate armor is made of glistening metal that scatters tiny specs of light each time it's doffed, which can be done as a Magic action. On command as a bonus action, it glows with a pale blue light, shedding 10-ft bright light and 10-ft more dim, or stops.",
		descriptionFull : "This plate armor is made of glistening metal that scatters tiny specs of light each time it is doffed. It can glow on command with a pale blue light.\n   " + toUni("Beacon") + ". You can take a Bonus Action to cause the item to shed Bright Light in a 10-foot radius and Dim Light for an additional 10 feet, or to extinguish the light.\n   You can doff this armor as a Magic action.",
		armorAdd : { select : "Cast-Off Plate", options : ["Cast-Off Plate"] },
		action : [["action", "Cast-Off Plate"], ["bonus action", "Cast-Off Plate (light/dim)"]],
	},
	...
	"smoldering plate (fr-dc-ulcaster-1)" : {
		name : "Smoldering Plate (FR-DC-ULCASTER-1)",
		source : [["AL", "FR-DC"]],
		type : "armor (medium)",
		description : "Wisps of harmless, odorless smoke rise from this plate armor while it is worn. I suffer no harm in extreme temperatures past 0\u00B0F and 100\u00B0F.",
		descriptionFull : "Wisps of harmless, odorless smoke rise from this armor while it is worn.\n   " + toUni("Temperate") + ". You are unharmed by temperatures of 0 degrees Fahrenheit or lower, and 100 degrees Fahrenheit or higher.",
		armorAdd : { select : "Smoldering Plate", options : ["Smoldering Plate"] },
		savetxt : { immune : ["temps past 0\u00B0F/100\u00B0F"] },
	},
}
})
...
MagicItemsList["al armor (other)"] = {
	...
	"dwarven half plate (fr-dc-mcg-inn1)" : {
		name : "Dwarven Half Plate (MCG-INN1)",
		source : [["AL", "FR-DC"]],
		type : "armor (half plate)",
		rarity : "very rare",
		magicItemTable : "?",
		description : "While wearing this dwarven half plate, I gain +2 AC. If an effect moves me against my will along the ground, I can reduce the distance moved by up to 10 ft as a reaction. I also feel more self-assured.",
		descriptionFull : "While wearing this half plate armor, you gain a +2 bonus to Armor Class. In addition, if an effect moves you against your will along the ground, you can take a Reaction to reduce the distance you are moved by up to 10 feet.\n   " + toUni("Confident") + ". The item helps its bearer feel self-assured.",
...
MagicItemsList["al shields"] = {
	...
	"shield of the cavalier (fr-dc-mcg-inn1)" : {
		...
		rarity : "very rare",
		magicItemTable : "?",
		description : "This shield adds extra +2 AC and can be attuned in 1 min. It can be used for 1 atk of Attack action vs target in 5 ft. As Reaction once per dawn, if me or ally in 5 ft targeted by atk or AOE, form immobile 5-ft sphere from me. Creatures or objects not fully inside pushed to empty space. Nothing passes in or out, including trigger effect. Lasts 1 min with Conc.",
		descriptionLong : "I can attune to this shield in 1 minute. While held, I gain an extra +2 AC. When I take the Attack action, I can make 1 of the attacks with the shield against a target in 5 ft. It does 2d6 + 2 + Str Force dmg and can Push creature 10 ft. Can also knock Prone if my size or smaller. As a Reaction once per dawn, if me or ally in 5 ft is targeted by attack or saves vs an Area of Effect, I can create an immobile 5-ft Emanation radiating from me. Any creature or object not fully in sphere is pushed to nearest empty space. Nothing can pass in or out, including the triggering effect. This sphere lasts for up to 1 minute and takes Concentration.",
	...
	"shield of the cavalier (fr-dc-nbdd-2)" : {
		name : "Shield of the Cavalier (NBDD-2)",
		source : [["AL", "FR-DC"]],
		rarity : "very rare",
		magicItemTable : "?",
		description : "This shield adds extra +2 AC and warns me like a whiny teenage boy, giving +2 initiative unless Incapacitated. It can be used for 1 attack of Attack action vs target in 5 ft. As Reaction once per dawn, if me or ally in 5 ft targeted by attack or AOE, form immobile 5-ft sphere from me. Creatures or objects not fully inside pushed to empty space. Nothing passes in or out, including trigger effect. Lasts 1 min with Conc.",
