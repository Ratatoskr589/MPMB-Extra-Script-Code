...
FeatsList["al story awards"] = {
	...
	"blessing of valhalla: the friends you made along the way (sj-dc-dd-11)" : {
		...
		source : [["AL","SJ-DC"]],
		description : "The Monad has taken you on numerous adventures and the bonds you built across worlds will last a lifetime. No matter where you are, you can always count on your fellow passengers and friends from Wildspace to come to your aid. All you need to do is call. As an action once per 7 days, 2d4+2 friendly warrior spirits (Berserker statblock) appear within 60 ft. They're friendly to you and follow your commands, disappearing after 1 hr or at 0 hp.",
	...
	"charm of the comet: enchanted amulet (fr-dc-pandora-jwei-7)" : {
		...
		source : [["AL","FR-DC"]],
		description : "This amulet grants you a portion of the charm and beauty of Sune to draw attention to yourself. As an action, you can force a visible creature within 60 ft to focus on you. For 1 minute, creatures other than you and the target are invisible to the target. The effect ends if any creature other than you damages the target or forces them to make a saving throw. Charm vanishes once used 3 times.",
